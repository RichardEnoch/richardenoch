...
const SWATCHES = [
  {
    hex: "#072561",
    name: "Deep Navy",
    role: "The dependable half. Uniforms, print, the steady base.",
    dark: false,
  },
  {
    hex: "#01b1ed",
    name: "Sky Blue",
    role: "The fresh half. Clean air, clear water, open windows.",
    dark: true,
  },
  {
    hex: "#ffffff",
    name: "White",
    role: "The point of the whole business.",
    dark: true,
  },
];
    ...
    <div className="relative z-10">
          ...
          <div className="max-w-[820px] mx-auto flex flex-col items-center text-center">
            ...
            <FadeUp delay={0.14}>
              <p className="text-[16px] sm:text-[18px] leading-[1.65] text-white/65 max-w-[600px]">
                A cleaning and property care service in Lagos, and the quietest
                brand in this portfolio on purpose. A well-made wordmark, two
                blues, a lot of white.
          ...
          <Reveal>
            <ProjectMeta
              ...
              items={[
                ...
                { label: "Industry", value: "Cleaning & Property Care" },
          ...
          <Reveal>
            ...
            >
              ...
              <p className="text-[16px] sm:text-[18px] leading-[1.7] text-white/70">
                Cleanstead keeps homes clean and properties in order, and they
                wanted a brand as straightforward as that promise: fresh,
                modern, dependable. So I kept it a wordmark, built it well, and
                grew everything outward from it. No hidden meanings, no battles,
                no war story. Some projects are won by conviction on a call.
                This one was won by getting the fundamentals right and leaving
                them alone.
              </p>
            </div>
          </Reveal>
          ...
          <ScrollAlign className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            <Reveal>
              ...
              <div className="space-y-5 text-[15px] sm:text-[16px] leading-[1.7] text-white/55">
                <p>
                  Cleanstead is a cleaning and property care service in Lagos.
                  Homes kept clean, spaces kept in order, on a schedule you stop
                  thinking about because it just happens. Their business runs on
                  a particular kind of trust: clients hand these people the keys
                  to their homes.
                </p>
                <p>
                  What they wanted from the brand matched that exactly. Simple
                  and modern. Fresh and dependable. Nothing flashy, because
                  flashy is not what you want from the person holding your keys.
                </p>
              </div>
            </Reveal>
            <Reveal>
              <Frame
                src={imgIdCard}
                alt="A Cleanstead staff ID card on a branded lanyard"
                ratio="4/5"
              />
            </Reveal>
          </ScrollAlign>
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-8 lg:px-16 border-t border-white/5">
        <div className="max-w-[1100px] mx-auto">
          <Reveal>
            ...
            <h2 className="type-display-3">
              <span className="text-white">The hardest part?</span>
              <br />
            ...
            <div className="max-w-[720px] space-y-5 text-[15px] sm:text-[16px] leading-[1.7] text-white/55">
              <p>
                There was no big tension to untangle here, and that is worth
                saying plainly. No loaded name to decode, no market to argue
                with, no first concept to retire. The brief was as clean as the
                service.
              </p>
              <p>
                Which is its own kind of trap. When a project is this open, the
                temptation is to add cleverness the brand never asked for, a
                hidden symbol, an over-engineered mark, a concept that needs
                explaining. A cleaning company does not need any of that. It
                needs to feel tidy and sure of itself, the visual equivalent of
                a spotless room. The real discipline was knowing that and
                holding to it.
              </p>
            </div>
          </Reveal>
        ...
        <div className="max-w-[1100px] mx-auto">
          <Reveal>
            ...
            <div className="max-w-[720px] space-y-5 text-[15px] sm:text-[16px] leading-[1.7] text-white/55 mb-10">
              <p>
                I kept it a wordmark. One clean, well-made setting of the name,
                weighted so Clean and stead read as two thoughts in one word,
                finished with a small sparkle, the only ornament the identity
                allows itself. Then everything else grew outward from it: the
                two blues, the supporting shapes, the way the pieces sit
                together on a card, a shirt, a van.
              </p>
              <p>
                That is the whole idea, and it is supposed to be. The restraint
                matches what the company actually does. Cleaning is not clever.
                It is done properly or it is not, and the brand says which side
                Cleanstead is on before you read a single word of copy.
              </p>
            </div>
          </Reveal>
          ...
          <Reveal>
            <div className="rounded-2xl overflow-hidden border border-white/8">
              <img
                src={imgStationery}
                alt="The Cleanstead wordmark across the stationery system: letterhead, cards and envelopes in two blues"
                loading="lazy"
                className="w-full h-auto"
              />
            </div>
            <p className="mt-4 text-[14px] text-white/40 leading-relaxed max-w-[640px]">
              The wordmark carrying the whole system. Same voice on every piece,
        ...
        <div className="max-w-[1100px] mx-auto">
          <Reveal>
            ...
            <div className="mt-6 max-w-[720px] space-y-5 text-[15px] sm:text-[16px] leading-[1.7] text-white/55 mb-12">
              <p>
                The palette says fresh and dependable the way the brief asked,
                in colour form. A deep navy carries the dependable half: the
                uniforms, the print, the base everything stands on. A bright sky
                blue carries the fresh half: clean air, clear water, the feeling
                of a room with the windows open. And white does the rest,
                because white is literally what this company sells.
              </p>
              <p>
                Under the wordmark sits the line that does the brand's talking:
                why clean when we can? Friendly, direct, and exactly as unclever
                as the rest of the system. It shows up on the reception wall,
                the door hangers and the vans, and it never needs a footnote.
              </p>
            </div>
          </Reveal>
          ...
          <Reveal>
            ...
            <div className="max-w-[720px] space-y-5 text-[15px] sm:text-[16px] leading-[1.7] text-white/55 mb-10">
              <p>
                Because the identity is one wordmark and two colours, it behaves
                everywhere without supervision. On a reception wall it reads
                corporate and calm. On a social card it reads friendly. On a
                pattern it dissolves into texture without losing itself. Systems
                built on restraint travel light.
              </p>
            </div>
            <div className="rounded-2xl overflow-hidden border border-white/8">
              <img
                src={imgReception}
                alt="The Cleanstead reception wall with the brand pattern and wordmark"
                loading="lazy"
                className="w-full h-auto"
              />
            </div>
        ...
        <div className="max-w-[1100px] mx-auto">
          <Reveal>
            ...
            <p className="mt-5 text-[15px] sm:text-[16px] leading-[1.7] text-white/55 max-w-[620px] mb-14">
              A service brand lives on vans, doors and billboards. If it stays
              calm out there, it was built right.
            </p>
          </Reveal>
            ...
            {[
              ...
              <Reveal key={title}>
                <div className="flex flex-col gap-5">
                  ...
                  <Frame
                    src={img}
                    alt={`${title}. Cleanstead brand application`}
                    ratio={ratio}
        ...
        <div className="max-w-[1100px] mx-auto">
          <Reveal>
            ...
            <p className="mt-5 text-[15px] sm:text-[16px] leading-[1.7] text-white/55 max-w-[560px] mb-12">
              On this project the decisions were mostly about what not to do.
              Those count too.
            </p>
          </Reveal>
      ...
      <BrandGallery
        ...
        images={[
          {
            src: imgSignage,
            alt: "Cleanstead building signage",
            label: "SIGNAGE",
          },
          { src: imgVan, alt: "Van livery in the two blues", label: "THE VAN" },
          {
            src: imgIdCard,
            alt: "Staff ID card on a lanyard",
            label: "ID CARD",
          },
          { src: imgShirt, alt: "Staff uniform shirt", label: "UNIFORM" },
          {
            src: imgStationery,
            alt: "Stationery system flat lay",
            label: "STATIONERY",
          },
          {
            src: imgReception,
            alt: "Reception wall with the brand pattern",
            label: "RECEPTION",
          },
          {
            src: imgBillboard,
            alt: "Spend time with the kids billboard",
            label: "BILLBOARD",
          },
          { src: imgHanger, alt: "Cleaned door hanger", label: "DOOR HANGER" },
          {
            src: imgSocial,
            alt: "Social media posts on a phone",
            label: "SOCIAL",
          },
          {
            src: imgFlyers,
            alt: "Cleaning with Standard flyers",
            label: "FLYERS",
          },
        ]}
      />
        ...
        <div className="max-w-[860px] mx-auto">
          <Reveal>
            ...
            <div className="mt-8 space-y-5 text-[15px] sm:text-[16px] leading-[1.75] text-white/60">
              <p>
                They were happy, the identity did its job, and Cleanstead goes
                about its work looking exactly like what it is: fresh,
                dependable, and sure of itself. The wordmark holds the vans, the
                doors, the uniforms and the billboards without ever raising its
                voice.
              </p>
              <p>
                It sits in this portfolio as the quiet piece, and it earns the
                spot. Not every strong project needs a war story. Some just need
                the fundamentals done properly and the confidence to stop there.
              </p>
            </div>
          </Reveal>
