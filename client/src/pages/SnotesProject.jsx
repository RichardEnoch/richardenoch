      ...
      >
        {src ? (
          ...
          <div
            ...
            style={{
              background:
                "repeating-linear-gradient(45deg, #0f1318 0px, #0f1318 10px, #111820 10px, #111820 20px)",
            }}
          >
            <svg
              width="32"
            ...
            <p
              className="text-center text-[11px] font-semibold leading-[1.5] text-white/40 max-w-[220px]"
...
const PERSONAS = [
  {
    ...
    img: asset("snotes/persona-richard"),
    caption:
      "Stylised portrait: young Nigerian man with Bible/phone, thoughtful",
    about:
  ...
  },
  {
    ...
    img: asset("snotes/persona-tosin"),
  ...
  },
  {
    ...
    img: asset("snotes/persona-daniel"),
          ...
          >
            ...
            {!p.img && (
              <div className="absolute inset-0 flex items-center justify-center px-4">
                <p
                  className="text-[10px] font-semibold text-center leading-[1.5]"
                  style={{ color: "rgba(163,230,53,0.35)" }}
                >
                  {p.caption}
                </p>
              </div>
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to top, #07090C 0%, rgba(7,9,12,0.82) 35%, rgba(7,9,12,0.3) 65%, rgba(7,9,12,0.05) 100%)",
              }}
            />
            ...
            {isActive && (
              <div
                ...
                style={{
                  boxShadow:
                    "inset 0 0 0 1px rgba(163,230,53,0.3), 0 0 40px 8px rgba(163,230,53,0.12)",
                }}
              />
            )}
      ...
      <div className="relative z-10">
          ...
          <div className="relative max-w-[1100px] mx-auto">
            ...
            <FadeUp delay={0.1}>
              <h1
                ...
                style={{
                  background:
                    "linear-gradient(180deg, #ffffff 0%, #7a7a7a 100%)",
              ...
              <p className="text-[16px] sm:text-[18px] leading-[1.65] text-white/55 max-w-[580px] mb-10">
                A focused mobile sermon note-taking app — built quietly, for
                people who want to actually live what they hear.
              </p>
            </FadeUp>

            <FadeUp delay={0.2}>
              <div
                className="relative rounded-2xl sm:rounded-3xl overflow-hidden border border-white/10 shadow-[0_0_80px_rgba(163,230,53,0.08)]"
                style={{ minHeight: 320 }}
              >
                ...
                {asset("snotes/hero") ? (
                  <img
                    src={asset("snotes/hero")}
                    alt="Snotes — the hero composition"
                  ...
                  >
                    <div className="flex flex-col items-center gap-3 p-10">
                      ...
                      <p
                        className="text-[12px] font-semibold text-center max-w-[300px] leading-[1.5]"
                        style={{ color: "rgba(163,230,53,0.5)" }}
                      >
                        Hero composition — snotes/hero
                      </p>
                    </div>
                  </div>
                )}
          ...
          <div className="max-w-[1100px] mx-auto">
            ...
            <div className="grid lg:grid-cols-[1fr_320px] gap-10 lg:gap-16 items-start">
              <SlideIn direction="left" delay={0.1}>
                ...
                <div
                  className="mt-5 mb-6 h-[2px] w-16 rounded-full"
                  style={{ background: GR }}
                />

                <p className="text-[15px] sm:text-[16px] leading-[1.65] text-white/55 mb-5">
                  Snotes is a mobile sermon note-taking app conceived as a
                  personal product first, with a structured path to broader
                  release. Most churchgoers use the default Notes app on their
                  phone to capture sermon notes — a tool built for grocery
                  lists, not for the rhythm of a teaching that weaves scripture,
                  exhortation, and personal conviction. Snotes treats scripture
                  as structured data, action points as first-class commitments,
                  and AI as an ambient companion — not a productivity tool, not
                  a Bible study app, not a social network.
                </p>
                <p className="text-[15px] sm:text-[16px] leading-[1.65] text-white/55 mb-8">
                  I'm building Snotes the same way I built my personal Life &
                  Work OS — first for me, then for the people who pray for me,
                  then (eventually) for the people I've never met who carry the
                  same Bible to church on Sunday. This case study captures the
                  strategy and conceptual phase before design and build.
                </p>
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <span
                      key={d}
                      className="rounded-full border border-white/12 bg-white/[0.04] px-3 py-1.5 text-[12px] text-white/60"
                    >
                      {d}
                    </span>
                  ))}
              ...
              <SlideIn direction="right" delay={0.15}>
                <div className="rounded-2xl border border-white/8 bg-white/[0.025] p-6">
                  ...
                  <p className="text-[15px] leading-[1.65] text-white/55 mb-4">
                    I led Snotes from problem identification to product strategy
                    and concept architecture, owning:
                  </p>
                  <ul className="space-y-2">
                    {[
                      ...
                      <li
                        key={item}
                        className="flex items-start gap-2.5 text-[15px] text-white/60"
                      >
                        <span
          ...
          <div className="max-w-[1100px] mx-auto">
            <div className="grid lg:grid-cols-[1fr_340px] gap-10 lg:gap-16 items-start">
              <FadeUp>
                ...
                />
                <p className="text-[15px] sm:text-[16px] leading-[1.65] text-white/55 mb-8">
                  Sermon notes are taken in the wrong place. The result is
                  predictable — notes get lost, scripture references stay as
                  plain text, action points die in untitled lists, and
                  reflection rarely happens. Four core problems, mapped from
                  personal use:
                </p>
                <ul className="space-y-3">
                  {[
                    {
                      n: "01",
                      title: "Notes are unstructured",
                      desc: "Default Notes apps don't understand the anatomy of a sermon — service type, minister, anchor scriptures, body, action points. Everything is plain text, lost among grocery lists and reminders.",
                    },
                    {
                      n: "02",
                      title: "Scripture is treated as text",
                      desc: 'Bible references like "John 3:16" sit as plain characters. No autocomplete, no inline expansion, no aggregation. The most important content in a sermon note is the least functional.',
                    },
                    {
                      n: "03",
                      title: "Action points die in the list",
                      desc: "The whole point of a sermon is application — but action points get buried inside the note where they were written, with no cross-note view, no state tracking, no follow-up.",
                    },
                    {
                      n: "04",
                      title: "Reflection never happens",
                      desc: "Notes get saved and forgotten. No nudge to revisit, no prompt to reflect, no way to know if last month's conviction is still active.",
                    },
                  ].map(({ n, title, desc }) => (
                    <li
                      key={n}
                      className="flex items-start gap-4 rounded-2xl border border-[#E0525222] bg-[#1A0A0A] p-5"
                    >
                      <span className="shrink-0 w-7 h-7 rounded-full border border-[#E0525244] flex items-center justify-center text-[10px] font-bold text-[#E05252]">
                        {n}
                      </span>
                      <div>
              ...
              <SlideIn direction="right" delay={0.15}>
                <TiltFrame
                  src={asset("snotes/problem-split")}
          ...
          <div className="max-w-[1100px] mx-auto">
            <FadeUp>
              ...
              <p className="mt-5 text-[15px] sm:text-[16px] leading-[1.65] text-white/55 max-w-[600px]">
                Research combined personal use, market scanning of existing
                tools, and structural analysis of the sermon note-taking
                experience. The conclusion was clear: nothing on the market
                solves this specific use case well.
              </p>
            </FadeUp>
                    ...
                    <table className="w-full h-full text-left border-collapse">
                      <thead>
                        <tr className="border-b border-white/8">
                          <th className="px-5 py-3 text-[11px] font-semibold text-white/40 w-[44%]">
                            Feature
                          </th>
                          <th
                            className="px-3 py-3 text-[11px] font-semibold text-center"
                            style={{ color: GR }}
                          >
                            Snotes
                          </th>
                          <th className="px-3 py-3 text-[11px] font-semibold text-white/40 text-center">
                            YouVersion
                          </th>
                          <th className="px-3 py-3 text-[11px] font-semibold text-white/40 text-center">
                            Logos
                      ...
                      <tbody>
                        {[
                          {
                            f: "Built for sermon note-taking",
                            s: true,
                            y: false,
                            l: false,
                            e: false,
                          ...
                          {
                            f: "Inline scripture autocomplete",
                            s: true,
                            y: false,
                            l: false,
                            e: false,
                          ...
                          {
                            f: "Auto-populated anchor scriptures",
                            s: true,
                            y: false,
                            l: false,
                            e: false,
                          ...
                          {
                            f: "Action points as first-class entity",
                            s: true,
                            y: false,
                            l: false,
                            e: false,
                          ...
                          {
                            f: "Service-aware reminders & focus",
                            s: true,
                            y: false,
                            l: false,
                            e: false,
                          ...
                          {
                            f: "AI-driven reflection prompts",
                            s: true,
                            y: false,
                            l: false,
                            e: false,
                          ...
                          {
                            f: "Designed for the pew (not study)",
                            s: true,
                            y: false,
                            l: false,
                            e: false,
                          ...
                          >
                            <td className="px-5 py-3 text-[15px] text-white/70">
                              {f}
                            </td>
                ...
                <div className="flex flex-col gap-4 h-full">
                  ...
                  <div className="rounded-2xl border border-white/8 bg-white/[0.025] p-5 flex-1 flex flex-col justify-center">
                    ...
                    <div className="flex items-center gap-5">
                      ...
                      <div>
                        <p className="text-[15px] font-semibold text-white leading-tight mb-1">
                          of personal sermon notes
                        </p>
                        <p className="text-[15px] leading-[1.6] text-white/50">
                          over six months of services — captured on the default
                          Notes app. Not one was reopened after the week it was
                          written.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="rounded-2xl border border-white/8 bg-white/[0.025] p-5 flex-1 flex flex-col justify-center">
                    ...
                    <p className="text-[11px] leading-[1.5] text-white/30 mt-3">
                      Feature coverage across the nine pillars defined for
                      sermon note-taking.
                    </p>
                  </div>
                </div>
        ...
        <section className="py-10 sm:py-16 px-3 sm:px-6">
          <FadeUp className="max-w-[1100px] mx-auto">
            {asset("snotes/visual-band") ? (
              <img
                src={asset("snotes/visual-band")}
                alt="Snotes — the mid-page visual band"
                className="w-full object-cover"
                style={{ minHeight: 320, maxHeight: "60vh" }}
              />
            ) : (
              <div
                className="rounded-2xl sm:rounded-3xl overflow-hidden border-2 flex items-center justify-center aspect-[4/5] sm:aspect-[16/9]"
                style={{
                  borderColor: `${GR}55`,
                  background:
                    "repeating-linear-gradient(45deg, #0f1318 0px, #0f1318 10px, #111820 10px, #111820 20px)",
              ...
              >
                <div className="flex flex-col items-center gap-3">
                  ...
                  <p
                    ...
                    style={{ color: "rgba(163,230,53,0.5)" }}
                  >
                    Visual band — snotes/visual-band
                  </p>
                </div>
              </div>
            )}
          ...
          <div className="max-w-[1100px] mx-auto">
            <FadeUp>
              ...
              <p className="mt-5 text-[15px] sm:text-[16px] leading-[1.65] text-white/55 max-w-[560px]">
                Snotes is built around four wedges that, together, no existing
                tool combines. Each one resolves a specific problem the default
                Notes app can't solve.
              </p>
            </FadeUp>
            ...
            <div className="mt-12 space-y-10">
              {[
                {
                  n: "01",
                  name: "Inline Scripture Autocomplete",
                  ...
                  imageKey: "snotes/feature-autocomplete",
                  caption:
                    "Phone mockup: scripture autocomplete chip rising above cursor with annotated callouts",
                  flip: false,
                },
                {
                  n: "02",
                  name: "Anchor Scriptures Auto-Populate",
                  ...
                  imageKey: "snotes/feature-anchor-scriptures",
                  caption:
                    "Phone mockup: note header with auto-populated anchor scriptures listing five references",
                  flip: true,
                },
                {
                  n: "03",
                  name: "Action Points as a First-Class Entity",
                  ...
                  imageKey: "snotes/feature-action-points",
                  caption:
                    "Phone mockup: action points tab with items grouped by state and parent-sermon context",
                  flip: false,
                },
                {
                  n: "04",
                  name: "Service-Aware Ambient AI",
                  ...
                  imageKey: "snotes/feature-service-aware",
                  caption:
                    "Phone mockup sequence: pre-service reminder, in-service focus indicator, post-service reflection prompt",
                  flip: true,
                },
                {
                  n: "05",
                  name: "Degrade Gracefully, Restore Intelligently",
                  ...
                  imageKey: "snotes/feature-offline",
                  caption:
                    "Visual diagram: offline note-taking on one side, online retroactive tagging on the other",
                  flip: false,
                },
              ].map(({ n, name, desc, caption, imageKey, flip }) => (
                <div
                  key={n}
                  className={`grid lg:grid-cols-2 gap-8 lg:gap-12 items-center ${flip ? "lg:[&>*:first-child]:order-2" : ""}`}
                >
                  <SlideIn direction={flip ? "right" : "left"} delay={0.1}>
                    <div className="rounded-2xl border border-white/8 bg-white/[0.025] p-6 sm:p-8">
                      <span
                        className="inline-block rounded-md px-2 py-0.5 text-[9px] font-bold tracking-widest uppercase mb-4"
          ...
          <div className="max-w-[1100px] mx-auto">
            <FadeUp>
              ...
              <p className="mt-5 mb-10 text-[15px] sm:text-[16px] leading-[1.65] text-white/55 max-w-[540px]">
                Three distinct believer archetypes shaped every product decision
                — from feature priority to the AI's tone of voice.
              </p>
            </FadeUp>
            <FadeUp delay={0.1}>
              <PersonaSection />
          ...
          <div className="max-w-[1100px] mx-auto">
            <FadeUp>
              ...
              <p className="mt-5 text-[15px] sm:text-[16px] leading-[1.65] text-white/55 max-w-[520px]">
                Snotes is built for African Pentecostal and charismatic
                believers — Nigeria first, then West Africa, then the broader
                English-speaking Christian world.
              </p>
            </FadeUp>
            ...
            <StaggerGrid className="mt-10 grid sm:grid-cols-3 gap-4">
              {[
                {
                  title: "Young Adult Believers",
                  color: GR,
                  desc: "Smartphone-first churchgoers, 22–35, attending at least one weekly service. The V1 and V2 primary audience.",
                },
                {
                  title: "Married Couples",
                  color: "#60A5FA",
                  desc: "Spouses who attend church together and want shared visibility into each other's notes — the V2 spouse-mode audience.",
                },
                {
                  title: "Small Groups & Ministry Teams",
                  color: "#A78BFA",
                  desc: "Bible study groups, ministry teams, and church leadership circles who want to share what they've heard with people who already pray for them.",
                },
              ...
              <div className="rounded-2xl border border-white/8 bg-white/[0.025] p-5">
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <span
                      key={c}
                      className="rounded-full border border-white/12 bg-white/[0.04] px-3 py-1.5 text-[12px] text-white/55"
                    >
                      {c}
                    </span>
                  ))}
            ...
            <ScrollAlign className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
              <FadeUp delay={0.1}>
                ...
                <p className="text-[15px] sm:text-[16px] leading-[1.65] text-white/55 mb-6">
                  Snotes is structured to earn the right to scale. Each version
                  answers a distinct question. V1 doesn't try to be V3. The
                  product matures alongside the people using it.
                </p>

                {/* pull quote */}
                <blockquote
                  className="border-l-2 pl-5 mb-8"
                  style={{ borderColor: GR }}
                >
                  <p className="text-[15px] sm:text-[16px] leading-[1.7] italic text-white/70">
                    "V1 is for you. V2 is for the people who pray for you. V3 is
                    for the people you've never met but who carry the same Bible
                    to church on Sunday."
                  </p>
                </blockquote>
                ...
                <ul className="space-y-5">
                  {[
                    {
                      v: "V1",
                      label: "Snotes for One",
                      meta: "Android · ~1 month build · personal use",
                      desc: "A personal journal. One user, one device, no accounts, local-first. The minimum useful product to replace the default Notes app for sermon note-taking. Tests one question: Does this work for me?",
                    },
                    {
                      v: "V2",
                      label: "Snotes for the Close Circle",
                      meta: "Android · 1.5-month closed beta · 3–4 invited users",
                      desc: 'Adds identity, sync, and small trusted Circles — spouse, small group, ministry team. "Connective, not social" is the governing principle: no feed, no public counts, no streaks. Tests: Does this work for us?',
                    },
                    {
                      v: "V3",
                      label: "Snotes for the Church",
                      meta: "Android + iOS + Web · public release · Naira-first pricing",
                      desc: "Open release on Play Store and App Store. Freemium model: public-domain translations and core features free; licensed translations, multi-device sync, and Circles paid. Tests: Does this work for the Church?",
                    },
                  ].map(({ v, label, meta, desc }) => (
                    <li key={v} className="flex gap-4">
                      <span
                        className="shrink-0 mt-0.5 rounded-md px-2 py-0.5 text-[9px] font-bold tracking-widest uppercase h-fit"
                        style={{ background: `${GR}15`, color: GR }}
                      >
                        {v}
                      </span>
        ...
        <section className="py-16 sm:py-24 px-4 sm:px-8 lg:px-16 border-t border-white/5">
          <div className="max-w-[1100px] mx-auto">
            <FadeUp>
              ...
              <p className="mt-5 text-[15px] sm:text-[16px] leading-[1.65] text-white/55 max-w-[560px]">
                A three-tier layered approach to Bible content. Ensures every
                user has a translation that matches their context, the network
                never breaks the experience, and the architecture is already
                structured for a future commercial transition.
              </p>
            </FadeUp>
            ...
            <FadeUp delay={0.1} className="mt-10">
                ...
                {[
                  {
                    ...
                    fields: [
                      ...
                      { label: "Offline", value: "Yes" },
                      {
                        label: "Usage",
                        value:
                          "Autocomplete baseline, always-available fallback, retroactive tagging",
                      },
                    ],
                  },
                  {
                    ...
                    fields: [
                      ...
                      {
                        label: "Source",
                        value: "API.Bible (Starter — non-commercial, V1/V2)",
                      },
                      { label: "Offline", value: "No" },
                      {
                        label: "Usage",
                        value:
                          "Default translations for V1, used in scripture popups",
                      },
                    ],
                  },
                  {
                    ...
                    fields: [
                      ...
                      {
                        label: "Source",
                        value: "HelloAO Free Use Bible API (MIT licensed)",
                      },
                      { label: "Offline", value: "No (cacheable)" },
                      {
                        label: "Usage",
                        value: "Redundancy when Layer 2 unavailable",
                      },
                    ],
                  },
              ...
              <div className="mt-4 rounded-2xl border border-white/8 bg-white/[0.02] px-5 py-4 flex items-start gap-3">
                ...
                <p className="text-[15px] leading-[1.65] italic text-white/45">
                  V3 transitions to API.Bible Pro (commercial license) for
                  NKJV/NIV/AMP/MSG with FUMS reporting integrated. V1
                  architecture is already structured for this transition — no
                  rewrite needed.
                </p>
              </div>
            </FadeUp>
        ...
        <section className="py-16 sm:py-24 px-4 sm:px-8 lg:px-16 border-t border-white/5">
          <div className="max-w-[1100px] mx-auto">
            <FadeUp>
              ...
              <p className="mt-5 text-[15px] sm:text-[16px] leading-[1.65] text-white/55 max-w-[520px]">
                A snapshot of the V1 information model. V2 adds Accounts,
                Circles, and Shares. V3 adds Subscriptions and Localisation.
              </p>
            </FadeUp>
                      ...
                      <div className="p-4 flex flex-col gap-2 flex-1">
                        <div className="flex flex-wrap gap-1.5">
                          {fields.map((f) => (
                            <span
                              key={f}
                              className="rounded-md px-2 py-0.5 text-[10px] font-mono text-white/45 border border-white/8 bg-white/[0.02]"
                            >
                              {f}
                            </span>
                          ))}
          ...
          <div className="max-w-[1100px] mx-auto">
            <FadeUp>
              ...
              <p className="mt-5 text-[15px] sm:text-[16px] leading-[1.65] text-white/55 max-w-[480px]">
                Every product is a series of "why this, not that?" choices.
                These are the principled calls behind Snotes — and the
        ...
        <section className="py-16 sm:py-24 px-4 sm:px-8 lg:px-16 border-t border-white/5">
          <div className="max-w-[1100px] mx-auto">
            <FadeUp>
              ...
              <p className="mt-5 text-[15px] sm:text-[16px] leading-[1.65] text-white/55 max-w-[520px]">
                Snotes' V3 business model is freemium, naira-first, with a small
                set of paid features that respect the product's soul.
              </p>
            </FadeUp>
            ...
            <div className="mt-10 grid sm:grid-cols-2 gap-4">
              ...
              <FadeUp delay={0.1}>
                <div className="rounded-2xl border border-white/12 bg-white/[0.025] p-6 h-full flex flex-col gap-4">
                  <div>
                    <p className="text-[11px] font-bold tracking-widest uppercase text-white/40 mb-1">
                      FREE
                    </p>
              ...
              <FadeUp delay={0.15}>
                <div
                  className="rounded-2xl border p-6 h-full flex flex-col gap-4"
            ...
            <FadeUp delay={0.2} className="mt-4">
              <div className="rounded-2xl border border-[#E0525220] bg-[#1A0A0A] p-5">
                <p className="text-[9px] font-bold tracking-widest uppercase text-[#E05252] mb-2">
                  PERMANENT NON-GOALS — NO EXCEPTIONS, AT ANY USER COUNT
                </p>
                <p className="text-[15px] leading-[1.65] text-white/50">
                  No ads &nbsp;·&nbsp; No data sales (including aggregated)
                  &nbsp;·&nbsp; No gamification &nbsp;·&nbsp; No public feed
                  &nbsp;·&nbsp; No AI sermon generation
                </p>
              </div>
            </FadeUp>
          </div>
          ...
          <div className="max-w-[1100px] mx-auto">
            <ScrollAlign className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
              <FadeUp delay={0.1}>
                ...
                />
                <p className="text-[15px] sm:text-[16px] leading-[1.65] text-white/55 mb-5">
                  The concept phase is complete. Three concept documents (V1,
                  V2, V3) totalling ~10,000 words of structured product thinking
                  sit behind this page. The next deliverables are already in
                  motion.
                </p>
                <p className="text-[15px] sm:text-[16px] leading-[1.65] text-white/55 mb-8">
                  V1 build begins next quarter. Design first — visual identity,
                  UI system, key flow mockups — then engineering. Snotes ships
                  when it's quietly excellent. Not before.
                </p>
                <ul className="space-y-3">
                  {[
                    {
                      title: "Marketing strategy",
                      desc: "channels, positioning, go-to-market for Nigerian Pentecostal/charismatic communities",
                    },
                    {
                      title: "Project timeline",
                      desc: "V1 → V2 → V3 calendar with milestones",
                    },
                    {
                      title: "Financial projection",
                      desc: "running costs, monetisation model, naira/USD scenarios, break-even analysis",
                    },
                    {
                      title: "Product architecture",
                      desc: "data model, sync strategy, AI prompt design",
                    },
                    {
                      title: "V1 PRDs",
                      desc: "technical requirements and engineering specs",
                    },
                  ].map(({ title, desc }) => (
              ...
              <div className="rounded-2xl border border-white/8 bg-white/[0.025] p-8 sm:p-10">
                <div className="space-y-6 max-w-[720px]">
                  <p className="text-[15px] sm:text-[16px] leading-[1.75] text-white/65">
                    Snotes reinforced something I'd been circling for a while:
                    the best products are built quietly, for one user, before
                    they're built for everyone. The temptation in product
                    strategy is to design for the public release first — to
                    imagine the V3 audience and reverse-engineer the V1 from
                    there. That path produces a product trying to be everything
                    to everyone, and pleasing no one.
                  </p>
                  <p className="text-[15px] sm:text-[16px] leading-[1.75] text-white/65">
                    Building Snotes "the same way I built Opus — first for me,
                    perhaps later for others" is the philosophical anchor. It
                    forces honest decisions. If V1 doesn't actually work for me,
                    V2 has no reason to exist. If V2 doesn't deepen
                    relationships in my closest circle, V3 has no soul to scale.
                    The phased rollout isn't a feature list — it's an integrity
                    check.
                  </p>
                  <p className="text-[15px] sm:text-[16px] leading-[1.75] text-white/65">
                    This case study also reinforced that{" "}
                    <strong className="text-white">
                      product strategy is design
                    </strong>
                    . Choosing what <em>not</em> to build is craft. Drawing the
                    bright lines (no ads, no data sales, no gamification) before
                    launch is the most consequential design decision Snotes will
                    ever make — because it removes the option to drift under
                    future pressure. Visual design comes next; the strategy
                    makes the visuals possible.
                  </p>
                </div>
                ...
                <div className="mt-8 pt-6 border-t border-white/8 flex items-center gap-3">
                  <div
                    ...
                    style={{ background: `${GR}25`, color: GR }}
                  >
                    R
                  </div>
                  <div>
                    ...
                    <p className="text-[11px] text-white/35">
                      Founder & Product Designer · Snotes Case Study · 2026
                    </p>
                  </div>
                </div>
              </div>
