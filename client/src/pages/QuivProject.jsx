...
const ImgPlaceholder = ({ label, note, aspect = "16/9", dim = false }) => (
  <div
    ...
    style={{
      aspectRatio: aspect,
      background: dim ? "rgba(59,142,240,0.04)" : "rgba(255,255,255,0.03)",
    }}
  >
    <div
    ...
    <p className="text-[12px] font-semibold text-center" style={{ color: QB }}>
      {label}
    </p>
    {note && (
      <p className="text-[11px] text-white/30 text-center max-w-[360px] leading-[1.55]">
        {note}
      </p>
    )}
  </div>
  ...
  <div className="relative min-h-screen bg-[#07090C] text-white overflow-x-hidden font-['Outfit']">
    ...
    <div className="relative z-10">
      ...
      <section className="relative min-h-[80vh] flex flex-col items-center justify-center overflow-hidden pt-28 pb-20 px-4">
        ...
        >
          A standalone desktop app replacing manual quantity take-off for
          Nigerian construction professionals — PDF-based measurement,
          BESMM-aligned, offline-first.
        </motion.p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
            <FadeUp>
              ...
              <p className="text-[15px] sm:text-[16px] leading-[1.65] text-white/55">
                As Creative Lead at ADLM Studio, I designed the full product
                experience for Quiv — the UI system, user flows, information
                architecture, and visual language. I worked alongside the
                product strategy and engineering direction, translating the
                product vision into a desktop interface built for quantity
                surveyors.
              </p>
            </FadeUp>
            <FadeUp delay={0.15}>
          ...
          <div className="grid lg:grid-cols-[1fr_380px] gap-12 lg:gap-20 items-start">
            <FadeUp delay={0.1}>
              ...
              <h2 className="text-4xl sm:text-5xl font-semibold leading-[1.05] tracking-[-0.03em] text-white mb-6">
                Manual take-off is
                <br />
                <span style={{ color: QB }}>costing QS professionals</span>
                <br />
                weeks of billable time
              </h2>
              <p className="text-[15px] sm:text-[16px] leading-[1.65] text-white/55 mb-8">
                Quantity Surveyors in Nigeria follow a 10-step manual process:
                receive drawings, prepare taking-off sheets, physically measure
                with a scale rule, record numbers by hand, collate across
                sheets, then transfer into Excel. A single complex project can
                take weeks before a single line of pricing begins.
              </p>

              <div className="rounded-2xl border border-white/8 bg-white/[0.025] px-5 pt-2">
                <PainRow
                  issue="Time-Intensive"
                  impact="Complex projects take days to weeks for take-off alone"
                />
                <PainRow
                  issue="Human Error"
                  impact="Manual scaling and transcription introduce inaccuracies at every step"
                />
                <PainRow
                  issue="Revision Hell"
                  impact="A single drawing change triggers complete remeasurement"
                />
                <PainRow
                  issue="Tool Lock-In"
                  impact="Existing BIM tools (Revit, CostX) cost NGN 4.5M+/year — out of reach"
                />
                <PainRow
                  issue="Format Mismatch"
                  impact="Nigerian QS work from PDFs, not BIM files — no tool served them"
                />
              </div>
            </FadeUp>
              ...
              <div className="lg:sticky lg:top-8">
                <div className="rounded-2xl border border-white/8 bg-white/[0.025] p-6 mb-4">
                  ...
                  <div className="flex flex-col gap-5">
                    <Stat
                      value="NGN 23.8T"
                      label="Nigerian construction industry (2024)"
                    />
                    <Stat
                      value="10,000+"
                      label="NIQS registered quantity surveyors"
                    />
                    <Stat
                      value="NGN 4.6M"
                      label="Revit annual cost — the barrier"
                    />
                    <Stat value="NGN 15K/mo" label="Quiv Solo plan pricing" />
                  </div>
                </div>
                <p className="text-[14px] text-white/25 italic leading-[1.65] px-1">
                  "If I could cut my takeoff time in half, I could double my
                  project load without sacrificing quality." — Target user
                  persona, ADLM Studio research
                </p>
              </div>
            </FadeUp>
          </div>
        ...
        <div className="max-w-[1100px] mx-auto">
          <FadeUp>
            ...
            <p className="text-[15px] sm:text-[16px] leading-[1.65] text-white/50 mt-5 max-w-[640px]">
              Quiv v1 was designed as an Autodesk Revit plugin — a technically
              solid solution that required an active Revit installation. Then
          ...
          <div className="mt-12 grid sm:grid-cols-2 gap-6">
            <SlideIn direction="left" delay={0.1}>
              <div className="rounded-2xl border border-white/8 bg-white/[0.025] p-6 h-full">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-white/5 text-white/30 border border-white/10">
                    Deprecated
                  </span>
                </div>
                ...
                <p className="text-[15px] text-white/45 leading-[1.65] mb-5">
                  A plugin within Autodesk Revit that read BIM element data
                  directly. Clean architecture, strong BIM integration. The
                  constraint: every user needed Revit installed.
                </p>
                <div className="rounded-xl border border-red-500/20 bg-red-500/5 px-4 py-3">
                  <p className="text-[14px] text-red-300/70 leading-[1.65]">
                    <strong className="text-red-300/90">The blocker:</strong>{" "}
                    Autodesk Revit costs NGN 4.5M+/year. Less than 2% of
                    Nigerian QS firms could afford it. The addressable market
                    was negligible.
                  </p>
                </div>
            ...
            <SlideIn direction="right" delay={0.15}>
              <div
                ...
                style={{
                  background: `linear-gradient(135deg, ${QB}44, transparent 60%)`,
                }}
              >
                <div className="rounded-2xl bg-[#07090C] p-6 h-full">
                  ...
                  <p className="text-[15px] text-white/55 leading-[1.65] mb-5">
                    Rebuilt from scratch as an Electron.js + React app. Instead
                    of BIM models, it works with the tool every Nigerian QS
                    already uses:{" "}
                    <strong className="text-white">PDF drawings</strong>.
                    Built-in PDF renderer, Fabric.js canvas for measurement
                    overlay, SQLite for offline storage, Supabase for cloud
                    sync.
                  </p>
        ...
        <div className="max-w-[1100px] mx-auto">
          <FadeUp>
            ...
            <p className="text-[15px] sm:text-[16px] leading-[1.65] text-white/50 max-w-[600px] mb-10">
              Quiv isn't one product — it's a pipeline. Each Fragment handles a
              distinct stage of the QS workflow, and data flows cleanly from one
              to the next.
            </p>
          </FadeUp>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-12">
            <Fragment
              num="1"
              name="Quiv Measure"
              desc="PDF-based quantity take-off. The core tool. Draw measurements on imported construction drawings and auto-generate structured take-off lists."
              tag="MVP"
            />
            <Fragment
              num="2"
              name="Quiv Cost"
              desc="Pricing and rate generation. Reads .quiv files from Measure directly — no re-entry. Maps quantities to rate database and generates Bills of Quantities."
            />
            <Fragment
              num="3"
              name="Quiv Tender"
              desc="Tender documentation assembly. Compiles BOQs, specifications, and contract documents into a single submission-ready package."
            />
            <Fragment
              num="4"
              name="Quiv Site"
              desc="On-site quantity verification. Compare designed quantities against as-built measurements during construction."
            />
            <Fragment
              num="5"
              name="Quiv Final"
              desc="Final account settlement. Handles post-construction variations, claims, and final cost reconciliation."
            />
            <Fragment
              num="6"
              name="Quiv Hub"
              desc="Central dashboard for all fragments. Project overview, team access, document history, and subscription management."
            />
          </div>
          ...
          <div className="py-14 border-t border-white/5">
            <div className="grid lg:grid-cols-[300px_1fr] gap-10 lg:gap-16 items-start">
              <SlideIn direction="left">
                <span
                  className="inline-flex items-center gap-2 rounded-full px-3 py-1 text-[10px] font-bold tracking-widest uppercase border mb-5"
                  style={{
                    borderColor: `${QB}44`,
                    color: QB,
                    background: `${QB}0D`,
                ...
                <p className="text-[15px] text-white/50 leading-[1.65]">
                  The central screen. A construction drawing rendered via PDF.js
                  with a Fabric.js canvas layered on top. The surveyor clicks to
                  place measurement points directly on the drawing — no scaling,
                  no manual entry. Dimensions are extracted automatically.
                </p>
              </SlideIn>
          ...
          <div className="py-14 border-t border-white/5">
            <div className="grid lg:grid-cols-[300px_1fr] gap-10 lg:gap-16 items-start">
              <SlideIn direction="left">
                ...
                <p className="text-[15px] text-white/50 leading-[1.65]">
                  When a project is created, Quiv generates a structured
                  checklist of every item the surveyor needs to measure —
                  ordered by construction sequence (Substructure →
                  Superstructure) and aligned with BESMM. No manual
                  list-building. The structure exists before a single
          ...
          <div className="py-14 border-t border-white/5">
            <div className="grid lg:grid-cols-[300px_1fr] gap-10 lg:gap-16 items-start">
              <SlideIn direction="left">
                ...
                <p className="text-[15px] text-white/50 leading-[1.65]">
                  After measurements are placed, the surveyor inputs additional
                  parameters (waste factor, depth, count). Calculations are
                  performed server-side and rendered in real time. The interface
                  preserves professional judgement — the system guides but never
                  overrides.
                </p>
              </SlideIn>
              <SlideIn direction="right" delay={0.1}>
          ...
          <div className="py-14 border-t border-white/5">
            <div className="grid lg:grid-cols-[300px_1fr] gap-10 lg:gap-16 items-start">
              <SlideIn direction="left">
                ...
                <p className="text-[15px] text-white/50 leading-[1.65]">
                  Completed take-offs export to Excel (.xlsx) in traditional
                  Taking-Off Sheet format — compatible with every existing QS
                  workflow. The .quiv format feeds directly into Quiv Cost
                  (Fragment 2) for pricing, with no re-entry. Data flows
          ...
          <ScrollAlign className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            <FadeUp>
              ...
              <p className="text-[15px] sm:text-[16px] leading-[1.65] text-white/55 mb-5">
                Quiv targets 10,000+ NIQS-registered quantity surveyors
                operating in a market with NGN 23.8 trillion in annual
                construction activity — with no software purpose-built for their
                workflow, their standards, or their budget.
              </p>
              <p className="text-[15px] sm:text-[16px] leading-[1.65] text-white/55">
                The product design had to do more than look good. It had to earn
                the trust of professionals who have done this work manually for
                decades — by being precise where they expect precision, and
                invisible where it doesn't matter.
              </p>
            </FadeUp>
            ...
            <FadeUp delay={0.15}>
              <div className="flex flex-col gap-4">
                {[
                  {
                    metric: "50%+",
                    desc: "Target time reduction vs. manual take-off (measured in pilot)",
                  },
                  {
                    metric: "95%+",
                    desc: "Calculation accuracy target vs. manual methods",
                  },
                  {
                    metric: "NGN 1.14B",
                    desc: "Addressable annual revenue at conservative market penetration",
                  },
                  {
                    metric: "3 months",
                    desc: "Target: 100 active users post-launch",
                  },
                ].map(({ metric, desc }) => (
                  <div
                    key={metric}
                    className="flex items-start gap-4 rounded-xl border border-white/8 bg-white/[0.025] px-5 py-4"
                  >
                    <p
                      className="text-2xl font-bold shrink-0 w-[90px]"
                      style={{ color: QB }}
                    >
                      {metric}
                    </p>
                    <p className="text-[15px] text-white/50 leading-[1.65] mt-1">
                      {desc}
                    </p>
                  </div>
                ))}
        ...
        <div className="max-w-[860px] mx-auto">
          <FadeUp>
            <blockquote
              ...
              style={{ borderColor: QB }}
            >
              <p className="text-[20px] sm:text-[24px] font-medium leading-[1.55] tracking-[-0.02em] text-white/75 mb-4">
                "I'm a trained Quantity Surveyor who became a designer. Quiv is
                what happened when I turned that training on itself — building
                the tool my profession has always needed but couldn't afford."
              </p>
              <cite className="not-italic text-[13px] text-white/35">
                Richard Enoch · Creative Lead, ADLM Studio
              </cite>
            </blockquote>
          </FadeUp>
        </div>
