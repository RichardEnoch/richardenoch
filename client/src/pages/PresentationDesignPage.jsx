...
const Img = ({ src, alt, className = "" }) => (
  <div
    className={`overflow-hidden rounded-2xl border border-white/8 ${className}`}
  >
    <img
      src={src}
      alt={alt}
        ...
        <section className="pt-28 sm:pt-36 pb-16 sm:pb-20 px-4 sm:px-6 text-center">
          ...
          <FadeUp delay={0.2}>
            <p className="mx-auto max-w-[580px] text-[15px] sm:text-[17px] leading-[1.65] text-white/50">
              From investor pitch decks to brand presentations — every deck is
              built to communicate your idea with clarity, confidence, and craft
              that holds the room.
            </p>
          </FadeUp>
          ...
          <div className="max-w-[1100px] mx-auto px-4 sm:px-6 mb-20">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                ...
                <div
                  key={label}
                  className="rounded-xl border border-white/8 bg-white/[0.03] px-5 py-4 text-center"
                >
                  <p
                  ...
                  <p className="mt-1.5 text-[11px] tracking-[0.1em] uppercase text-white/40">
                    {label}
                  </p>
                </div>
              ))}
          ...
          <div className="max-w-[1100px] mx-auto">
            <SlideIn direction="left">
              ...
              <p className="text-[15px] sm:text-[16px] leading-[1.65] text-white/50 max-w-[560px] mb-10">
                A full investor pitch deck for ADLM Studio's funding round —
                covering market opportunity, ecosystem overview, business model,
                financial projections, and ask. Built to hold attention in a
                room and convince on a screen.
              </p>
            </SlideIn>
            ...
            <FadeUp>
              <Img
                src={adlm3}
                alt="ADLM — Brand-infused visuals"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
              <FadeUp delay={0.05}>
                <Img
                  src={adlm2}
                  alt="ADLM — Crystal-Clear Messaging"
        ...
        <section className="py-20 sm:py-28 px-4 sm:px-6">
          <div className="max-w-[1100px] mx-auto">
            <SlideIn direction="right">
              ...
              <p className="text-[15px] sm:text-[16px] leading-[1.65] text-white/50 max-w-[560px] mb-10">
                A corporate pitch deck for Tradeflow — a technology platform
                simplifying cross-border trade and business expansion across
                Africa. Story-driven infographics, competitive comparison
                tables, and a financial projection narrative built to win trust
            ...
            <FadeUp>
              <Img
                src={tf06}
                alt="Tradeflow — Communicates value at first glance"
                className="w-full mb-5"
              />
            </FadeUp>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
              <FadeUp delay={0.05}>
                <Img
                  src={tf01}
                  alt="Tradeflow — Story-Driven Infographics"
                  className="w-full h-full"
                />
              </FadeUp>
              <FadeUp delay={0.12}>
                <Img
                  src={tf05}
                  alt="Tradeflow — Brand-infused visuals"
                  className="w-full h-full"
                />
              </FadeUp>
            </div>
        ...
        <section className="py-20 sm:py-28 px-4 sm:px-6">
          <div className="max-w-[1100px] mx-auto">
            <SlideIn direction="left">
              ...
              <p className="text-[15px] sm:text-[16px] leading-[1.65] text-white/50 max-w-[560px] mb-10">
                A dark-themed, tech-forward deck for AI2BC — an AI and
                blockchain company. Purpose-driven layouts, deep data
                visualisation, and a premium dark aesthetic that signals
                innovation and authority from the first slide to the last.
              </p>
            </SlideIn>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
              ...
              <FadeUp delay={0.12}>
                <Img
                  src={ai202}
                  alt="AI2BC — Purpose-Driven Layouts"
                  className="w-full h-full"
                />
              </FadeUp>
            </div>
              ...
              >
                <div className="flex-1">
                  ...
                  <p className="text-[14px] sm:text-[15px] leading-[1.65] text-white/45">
                    From light corporate blue to a full dark tech aesthetic —
                    the design adapts completely to the brand while keeping the
                    same level of craft, hierarchy, and intentional layout.
                  </p>
                </div>
                <div className="shrink-0 flex flex-col gap-3">
                  {["Corporate", "Fintech", "AI / Tech", "Personal Brand"].map(
                    (tag) => (
                      <span
                        key={tag}
                        className="inline-flex items-center gap-2 rounded-full border border-white/12 bg-white/5 px-4 py-1.5 text-[12px] font-medium text-white/60"
                      >
                        <span
                          className="h-1.5 w-1.5 rounded-full"
                          style={{ background: GR }}
        ...
        <section className="py-20 sm:py-28 px-4 sm:px-6">
          <div className="max-w-[1100px] mx-auto">
            <SlideIn direction="right">
              ...
              <p className="text-[15px] sm:text-[16px] leading-[1.65] text-white/50 max-w-[560px] mb-10">
                A personal brand presentation deck designed to help
                professionals stand out on LinkedIn — slide-by-slide narrative
                transitions that guide viewers from introduction to conversion
                without losing them on a single screen.
              </p>
            </SlideIn>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <FadeUp delay={0.05}>
                <Img
                  src={li196}
                  alt="LinkedIn — Story-led presentation design"
                  className="w-full h-full"
                />
              </FadeUp>
              <FadeUp delay={0.12}>
              ...
              {[
                {
                  ...
                  desc: "Every deck is structured as a narrative — beginning, tension, resolution — before a single slide is designed.",
                },
                {
                  icon: "◉",
                  title: "Brand-Infused Design",
                  desc: "Colors, typography, and layout all pulled from your brand so the deck feels like an extension of who you are.",
                },
                {
                  icon: "⬡",
                  title: "Data Visualisation",
                  desc: "Numbers, charts, and metrics turned into visuals that make impact — not walls of text.",
                },
                {
                  icon: "◈",
                  title: "Multi-Format Delivery",
                  desc: "Delivered in PowerPoint, PDF, and Canva-ready formats so you can present from anywhere.",
                },
                {
                  icon: "◉",
                  title: "Slide-by-Slide Logic",
                  desc: "Every slide earns its place. No filler. Each screen has one job and does it well.",
                },
                {
                  icon: "⬡",
                  title: "Revisions Included",
                  desc: "Two rounds of revisions are built into every project so you go into the room with full confidence.",
                },
              ].map(({ icon, title, desc }) => (
                <FadeUp key={title}>
                  <div className="rounded-xl border border-white/8 bg-white/[0.025] p-6 h-full">
                    <span
                      className="text-[20px] mb-3 block"
                      style={{ color: GR }}
                    >
                      {icon}
                    </span>
        ...
        <section className="py-16 sm:py-20 px-4 sm:px-6">
          <FadeUp>
            <div
              ...
              style={{
                borderColor: `${GR}30`,
                background: `linear-gradient(135deg, ${GR}08 0%, transparent 60%)`,
              }}
            >
              <p
              ...
              <p className="text-[15px] sm:text-[16px] leading-[1.65] text-white/45 mb-8 max-w-[480px] mx-auto">
                Got a pitch, a meeting, or a conference coming up? Let's make
                sure you walk in with something that does the talking.
              </p>
              <Link
                to="/contact"
