    ...
    plans: [
      {
        ...
        deliverables: [
          "10 slides",
          "Problem/solution/market layout",
          "Custom graphics",
          "Editable PPTX / Keynote",
        ],
      },
  ...
  "Publication Design": {
    ...
    plans: [
      ...
      },
      {
        ...
        deliverables: [
          "Unlimited pages",
          "Full editorial system",
          "Interactive PDF",
          "Distribution file prep",
          "Index & TOC design",
        ],
      },
    ],
    ...
    >
      <motion.div variants={item}>
        ...
        <p className="mt-3 text-sm leading-relaxed text-white/50">
          Have a project in mind? Reach out and
          <br />
              ...
              >
                <div className="flex items-center justify-between gap-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      className={`text-xs font-semibold ${isOpen ? "text-lime-300" : plan.featured ? "text-white/85" : "text-white/70"}`}
                    >
                      {plan.name}
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span
                      className={`text-xs font-bold tabular-nums ${isOpen ? "text-lime-400" : plan.featured ? "text-white/70" : "text-white/45"}`}
                    >
                      {plan.price}
                    </span>
                    <svg
...
const SuccessScreen = ({ onDiveBack }) => {
  useEffect(() => {
    ...
    fire(0.35, {
      spread: 60,
      startVelocity: 55,
      colors: ["#84cc16", "#bef264", "#ffffff"],
    });
    fire(0.25, {
      spread: 80,
      startVelocity: 45,
      colors: ["#84cc16", "#d9f99d", "#e5e5e5"],
    });
    fire(0.2, {
      spread: 100,
      startVelocity: 35,
    ...
    fire(0.1, {
      ...
      decay: 0.92,
      scalar: 1.2,
      colors: ["#bef264", "#a3e635"],
    });
    fire(0.1, {
      spread: 140,
      startVelocity: 45,
      colors: ["#84cc16", "#ffffff", "#d4d4d4"],
    });
  }, []);
    ...
    >
      ...
      <div className="relative lg:hidden h-52 shrink-0 overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to top, rgba(5,5,5,1) 0%, rgba(0,0,0,0.3) 60%, rgba(0,0,0,0.1) 100%)",
          }}
        />
        <div className="relative z-10 flex h-full flex-col justify-end px-6 pb-5">
          ...
          <p className="mt-1.5 text-xs leading-relaxed text-white/50">
            Have a project in mind? Reach out and let&apos;s explore what we can
            build together.
          </p>
        </div>
      </div>
      ...
      <div className="flex w-full gap-4 px-4 sm:px-8 pb-8 pt-4 lg:pt-12 lg:h-[calc(100vh-56px)] lg:overflow-hidden">
        ...
        <div
          ...
          style={{
            padding: "1.5px",
            background:
              "linear-gradient(135deg, rgba(255,255,255,0.22) 0%, rgba(180,180,180,0.06) 45%, rgba(255,255,255,0.16) 100%)",
            boxShadow:
              "0 0 48px rgba(220,220,220,0.07), 0 0 90px rgba(200,200,200,0.04)",
          }}
        >
