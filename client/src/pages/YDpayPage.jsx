    ...
    {src ? (
      ...
      <>
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-2 px-2 pb-3">
          ...
          >
            <span className="text-[9px] font-black" style={{ color: GR }}>
              yd
            </span>
          </div>
          {label && (
            <p className="text-[6px] text-white/25 text-center leading-tight px-1">
              {label}
            </p>
          )}
        </div>
...
const PhoneGrid = ({ screens, cols = 4 }) => {
  ...
  return (
    <div className="flex flex-col gap-2 sm:gap-3">
      ...
      >
        {top.map((s, i) => (
          <Phone key={i} label={s.label} src={s.src} />
        ))}
      </div>
      {bot.length > 0 && (
        <div
          className="grid gap-2 sm:gap-3"
          style={{
            gridTemplateColumns: `repeat(${Math.min(bot.length, cols)}, 1fr)`,
          }}
        >
          {bot.map((s, i) => (
            <Phone key={i} label={s.label} src={s.src} />
  ...
  <div className="py-16 sm:py-20 border-t border-white/5">
    <div className="grid lg:grid-cols-[320px_1fr] gap-10 lg:gap-16 items-end">
      ...
      <SlideIn direction="left">
        <span
          className="inline-flex items-center gap-2 rounded-full px-3 py-1 text-[10px] font-bold tracking-widest uppercase border mb-6"
          style={{
        ...
        <h3 className="text-2xl sm:text-3xl font-semibold text-white leading-tight tracking-[-0.02em]">
          {title}
        </h3>
        <p className="text-xs font-semibold mt-2 mb-4" style={{ color: GR }}>
          {count}
        </p>
        ...
        {screens && (
          <ul className="space-y-1">
            {screens.map(([id, name]) => (
              <li
                key={id}
                className="flex items-start gap-3 text-[13px] text-white/45"
              >
                <span className="font-mono text-[10px] text-white/25 mt-0.5 w-8 shrink-0">
                  {id}
                </span>
                <span>{name}</span>
              </li>
  ...
  <div className="relative min-h-screen bg-[#07090C] text-white overflow-x-hidden font-['Outfit']">
    ...
    <div className="relative z-10">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden pt-24 pb-16">
        ...
        {/* glow beneath mockup */}
        <div
          className="pointer-events-none absolute left-1/2 -translate-x-1/2 top-[38%] h-48 w-[65%] max-w-[640px] rounded-full blur-[90px] z-10"
        ...
        <motion.div
          className="relative z-10 mt-[10px] px-4 text-center"
        ...
        >
          Complete UX/UI redesign — 96 screens across 14 flows, built for trust,
          speed, and a premium crypto experience.
        </motion.p>
          ...
          <ScrollAlign className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
            <FadeUp>
              ...
              <p className="text-[15px] sm:text-[16px] leading-[1.65] text-white/55">
                Contracted UI Designer — responsible for UX audit, high-fidelity
                redesign, and new feature design: SpinPop (gamification),
                Refer'm'earn (referral flow), and admin dashboards for both.
                Full ownership of all 96 screens from IA to developer-ready
                Figma spec.
              </p>
            </FadeUp>
            <FadeUp delay={0.15}>
        ...
        <div className="max-w-[1100px] mx-auto">
          <div className="mt-0 grid lg:grid-cols-[1fr_340px] gap-12 lg:items-end">
            <FadeUp delay={0.1}>
              ...
              <h2 className="text-4xl sm:text-5xl lg:text-[56px] font-semibold leading-[1.05] tracking-[-0.03em]">
                <span className="text-white">What was</span>
                <br />
              ...
              <p className="text-[15px] sm:text-[16px] leading-[1.65] text-white/60 mb-5">
                YDPay required a ground-up redesign to transform it from a
                functional prototype into a{" "}
                <strong className="text-white font-semibold">
                  premium, trust-first crypto finance app
                </strong>
                . The previous design lacked a unified visual language, had no
                clear information hierarchy, and created friction at every
                money-movement interaction.
              </p>
              <p className="text-[15px] sm:text-[16px] leading-[1.65] text-white/60 mb-8">
                This redesign covers every screen a user touches — from first
                launch through KYC, daily trading, withdrawals, and account
                management — creating a cohesive, scalable design system built
                on Onest typography, a green-on-dark brand palette, and a clean
                4-action dashboard model.
              </p>
              {/* bullet rows */}
                ...
                {[
                  {
                    ...
                    desc: "one design system, zero visual inconsistencies across 96 screens",
                  },
                  {
                    dot: GR,
                    title: "Frictionless money movement",
                    desc: "Deposit, Withdraw, Send, Receive as 4 clear top-level actions",
                  },
                  {
                    dot: GR,
                    title: "Trust-first security model",
                    desc: "OTP gating on all outbound transactions, biometric fast-login, KYC tier system",
                  },
                  {
                    dot: "#EAB308",
                    title: "Developer-ready precision",
                    desc: "every screen spec'd at 393×844px, Onest font weights, exact hex values, spacing grid",
                  },
                ].map(({ dot, title, desc }) => (
                  <li
                    key={title}
            ...
            <FadeUp delay={0.2} className="flex flex-col gap-4">
                ...
                <div className="divide-y divide-white/5">
                  {[
                    ...
                    >
                      ...
                      <span
                        className={`font-bold ${small ? "text-[13px] text-white/60" : "text-[20px]"}`}
              ...
              >
                ...
                <p className="text-[13px] leading-[1.6] text-white/50">
                  All 96 screens delivered in Figma with developer-ready specs
                  and component documentation. Partial implementation adopted by
                  client — core flows shipped, new features pending.
                </p>
              </div>
            </FadeUp>
          </div>
            ...
            {[
              {
                ...
                result:
                  "Users couldn't establish trust or familiarity with the app's interaction patterns.",
              },
              {
                n: "02",
                title: "No Clear Dashboard Hierarchy",
                ...
                result:
                  "Users took longer to complete basic transactions because priority actions weren't visible at a glance.",
              },
              {
                n: "03",
                ...
                result:
                  "Users frequently missed taps, triggered wrong actions, or got lost between screens.",
              },
              {
                n: "04",
                title: "Font & Scale Inconsistencies",
                ...
                result:
                  "Key data like prices, account balances, and CTAs didn't have proper visual weight to command attention.",
              },
              {
                n: "05",
                title: "No Security UX Layer",
                ...
                result:
                  "Trust signals were absent. Users felt uncertain when completing sensitive transactions.",
              },
              {
                n: "06",
                ...
                result:
                  "Power users had to hunt for features they used daily, reducing retention and satisfaction.",
              },
              ...
              <StaggerItem key={n}>
                <div className="rounded-2xl border border-[#E0525222] bg-[#1A0A0A] p-5 h-full flex flex-col gap-4">
                  ...
                  <div className="border-t border-[#E0525218] pt-3">
                    <p className="text-[10px] font-bold tracking-widest uppercase text-[#E05252] mb-1">
                      AS A RESULT
                    </p>
                    <p className="text-[13px] leading-[1.65] text-[#E05252]/70">
                      {result}
                    </p>
                  </div>
                </div>
        ...
        <div className="max-w-[1100px] mx-auto">
          <FadeUp>
            ...
            <p className="mt-5 text-[15px] sm:text-[16px] leading-[1.65] text-white/55 max-w-[580px]">
              The redesign establishes a{" "}
              <strong className="text-white">
                premium, trust-first visual system
              </strong>{" "}
              — dark backgrounds that signal security, a signature green that
              communicates growth and confidence, clean white UI elements that
              provide clarity, and a 4-action home system.
            </p>
          </FadeUp>
              ...
              {[
                {
                  hex: "#05CB74",
                  name: "YDPay Green",
                  desc: "All CTAs · Success states · Active indicators · Brand elements · Confirmed transactions",
                },
                {
                  hex: "#171B1E",
                  name: "Deep Surface",
                  desc: "App background · Dark headers · Navigation bars · Card backgrounds in dark mode",
                },
                {
                  hex: "#FAFAFA",
                  name: "Surface White",
                  desc: "Content cards · Form backgrounds · White sheet layers · Elevated UI panels",
                },
                {
                  hex: "#FFCC00",
                  name: "Accent Yellow",
                  desc: "Warnings · KYC fee badges · Pending states · Highlight callouts",
                },
                {
                  hex: "#0C0D0F",
                  name: "True Dark",
                  desc: "Document / page background · Full-screen auth views · Splash and loading screens",
                },
              ].map(({ hex, name, desc }) => (
                <StaggerItem key={hex}>
            ...
            <div className="relative">
                ...
                {[
                  {
                    ...
                    spec: "96px · 900 · 1px",
                    el: (
                      <p className="text-[52px] sm:text-[64px] font-black leading-none tracking-tight text-white">
                        YDPay
                      </p>
                    ),
                  },
                  ...
                  },
                  {
                    ...
                    el: (
                      <p className="text-[15px] text-white/60 leading-relaxed max-w-[340px]">
                        Your balance is updated in real time. Tap any asset to
                        view details and manage your holdings.
                      </p>
                    ),
                  },
                  {
                    ...
                    el: (
                      <p className="text-[13px] text-white/50">
                        Review your transaction before confirming. Fees are
                  ...
                  <div
                    key={label}
                    className={`flex gap-6 px-6 py-4 ${i > 0 ? "border-t border-white/5" : ""}`}
                  >
              ...
              <div className="hidden lg:block absolute -right-24 top-0 w-[480px] pointer-events-none">
                <img
                  src={iphone16}
                  alt="YDpay screens"
                  className="w-full object-contain drop-shadow-[0_30px_60px_rgba(0,0,0,0.8)]"
                  loading="lazy"
                />
              </div>
            </div>
      ...
      <section className="py-10 sm:py-14 px-3 sm:px-6">
        <FadeUp className="max-w-[1100px] mx-auto">
          <div
            className="rounded-2xl sm:rounded-3xl overflow-hidden border-2 shadow-[0_0_60px_rgba(1,186,75,0.15)]"
            style={{ borderColor: `${GR}55` }}
          >
            <img
              src={iphone12}
              alt="YDpay two phones"
              className="w-full object-cover"
              loading="lazy"
            />
          </div>
        ...
        <div className="max-w-[1100px] mx-auto">
          <FadeUp>
            ...
            <p className="mt-5 text-[15px] sm:text-[16px] leading-[1.65] text-white/55 max-w-[520px]">
              Every flow, every screen — what it does, why it exists, and how it
              fits in the user journey.
            </p>
          </FadeUp>

          {/* Flow 01 */}
          <FlowBlock
            badge="Flow 01 · Authentication"
            num="01"
            ...
            screens={[
              ["L1", "Sign In Entry"],
              ["L2", "Biometric Prompt"],
              ["L3", "Error / Account Locked"],
              ["L4", "Forgot Password"],
              ["L5", "Resend OTP Verification"],
              ["L6", "Create New Password"],
              ["L7", "Password Reset Success"],
            ]}
          >
            <PhoneGrid
              screens={[
          ...
          <FlowBlock
            ...
            screens={[
              ...
              ["O2", "Enter Details"],
              ["O3", "Age Gate Error"],
              ["O4", "Email OTP Verification"],
              ["O5", "Account Created (Tier 0)"],
              ["O6–O10", "KYC Steps 1–4"],
              ["O11", "Verification Processing"],
              ["O12", "KYC Approved (Tier 1)"],
              ["O13–O14", "Google SSO Path"],
            ]}
          >
            <PhoneGrid
              screens={[
          ...
          <FlowBlock
            ...
            screens={[
              ["O1", "Dashboard V1 — Minimal"],
              ["O2", "Dashboard V2 — Full Actions"],
            ]}
          >
            <div className="rounded-2xl overflow-hidden border border-white/8">
              <img
        ...
        <div className="max-w-[1100px] mx-auto">
          <FadeUp>
            ...
            <p className="mt-5 text-[15px] sm:text-[16px] leading-[1.65] text-white/55 max-w-[560px]">
              The core design decision: four top-level actions that cover every
              way money moves through YDPay, with zero ambiguity about which to
              use.
            </p>
          </FadeUp>
              ...
              {[
                {
                  ...
                  label: "Deposit",
                  color: GR,
                  desc: "Fiat money IN from bank transfer or card payment. Requires verified account.",
                  otp: false,
                },
                {
                  icon: "↑",
                  label: "Withdraw",
                  color: "#F59E0B",
                  desc: "Fiat money OUT to a Nigerian bank account. Requires review and destination.",
                  otp: true,
                },
                {
                  icon: "→",
                  label: "Send",
                  color: "#3B82F6",
                  desc: "Crypto OUT — splits into two tabs: External Wallet (on-chain) or YDPay User (internal, free).",
                  otp: true,
                },
                {
                  icon: "↙",
                  label: "Receive",
                  color: "#EAB308",
                  desc: "Crypto IN via QR code or wallet address. Select asset, select network, share.",
                  otp: false,
                },
                ...
                >
                  ...
                  <p className="text-[13px] leading-[1.65] text-white/50 flex-1">
                    {desc}
                  </p>
                  <div
                    className={`rounded-md px-2 py-1 text-[9px] font-bold tracking-widest uppercase w-fit ${otp ? "bg-[#EF444420] text-[#EF4444]" : "bg-[#01BA4B15] text-[#01BA4B]"}`}
                  >
              ...
              <div className="grid sm:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <p className="text-[14px] leading-[1.65] text-white/50">
                    On-chain transfer to any crypto wallet address. Gas fee
                    applies. Network selector shown. TX hash on completion.
                  </p>
                </div>
                <div>
                  <p
                  ...
                  <p className="text-[14px] leading-[1.65] text-white/50">
                    Instant zero-fee transfer between YDPay accounts. Zero fees.
                    Settled immediately. No network selection needed.
                  </p>
                </div>
              </div>
              <div className="border-t border-white/6 pt-5">
                <p className="text-[11px] leading-[1.65] text-white/40">
                  <strong className="text-white/70">Why tabs?</strong> Previous
                  designs had separate nav items for "Send" and "Transfer" —
                  users didn't know which to use. Tabs keep both paths within
                  one flow entry point, with clear labels that explain the
                  difference.
                </p>
              </div>
            </div>
              ...
              {[
                {
                  ...
                  label: "Basic Access",
                  color: "#F59E0B",
                  desc: "Browse only. Can browse markets, receive crypto and deposit. Send and Withdraw are limited or require upgrade prompt shown on Dashboard.",
                },
                {
                  tier: "TIER 1",
                  label: "Full Access",
                  color: GR,
                  desc: "Address proof & ID, biometric-verified. Full access to all 14 flows with no transaction limits. Required for all money-out operations.",
                },
                ...
                >
                  <span
                    className="inline-block rounded-md px-2 py-0.5 text-[9px] font-bold tracking-widest mb-3"
                    style={{ background: `${color}20`, color }}
                  >
                    {tier}
                  </span>
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-8 lg:px-16 border-t border-white/5">
        <div className="max-w-[1100px] mx-auto">
          {/* Flow 04 */}
          <FlowBlock
            badge="Flow 04 · Deposit"
            badgeColor="#EF4444"
            num="04"
            title="Deposit Fiat In"
            count="7 screens"
            ...
            screens={[
              ...
              ["D2", "Enter Amount"],
              ["D3", "Review Transfer"],
              ["D4", "Bank Payment Details"],
              ["D5", "Card Payment Form"],
              ["D6", "Processing"],
              ["D7", "Deposit Success"],
            ]}
          >
          ...
          {/* Flow 05 */}
          <FlowBlock
            badge="Flow 05 · Withdraw"
            badgeColor="#F59E0B"
            num="05"
            title="Withdraw Fiat OUT"
            count="7 screens"
            ...
            screens={[
              ["D1", "Destination Select"],
              ["D2", "Add Bank Account"],
              ["D3", "Enter Amount"],
              ["D4", "Review Withdrawal"],
              ["D5", "PIN / OTP Verification"],
              ["D6", "Processing"],
              ["D7", "Withdrawal Success"],
            ]}
          >
            <PhoneGrid
              screens={[
          ...
          {/* Flow 06 */}
          <FlowBlock
            badge="Flow 06 · Send External"
            num="06"
            title="Send Crypto External Wallet"
            count="6 screens"
            ...
            screens={[
              ["SE1", "Entry / Tab Select"],
              ["SE2", "Recipient Address"],
              ["SE3", "Enter Amount"],
              ["SE4", "Network Select"],
              ["SE5", "Review Transaction"],
              ["SE6", "Send Success / TX Hash"],
            ]}
          >
            <PhoneGrid
              screens={[
          ...
          {/* Flow 07 */}
          <FlowBlock
            badge="Flow 07 · Send Internal"
            badgeColor="#06B6D4"
            num="07"
            title="Send to YDPay User"
            count="4 screens"
          ...
          {/* Flow 08 */}
          <FlowBlock
            badge="Flow 08 · Receive"
            badgeColor="#EAB308"
            num="08"
            title="Receive Crypto IN"
            count="3 screens"
        ...
        <div className="max-w-[1100px] mx-auto">
          <FadeUp>
            ...
            <p className="mt-5 text-[15px] sm:text-[16px] leading-[1.65] text-white/55 max-w-[480px]">
              Every major design choice has a clear reason. Here are the six
              decisions that most shaped the final product.
            </p>
          </FadeUp>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-8 lg:px-16 border-t border-white/5">
        <div className="max-w-[1100px] mx-auto">
          <FadeUp>
            ...
            <p className="mt-5 text-[15px] sm:text-[16px] leading-[1.65] text-white/55 max-w-[520px]">
              The full app hierarchy — every flow, every screen, organized by
              section. A complete IA tree and 10-journey flow map has been
              delivered separately as a 5200px wide Figma frame.
            </p>
          </FadeUp>
              ...
              {[
                {
                  ...
                  count: "4 screens",
                  color: "#6366F1",
                  items: ["S0 Splash", "S1–S3 Intro Slides"],
                },
                {
                  name: "Auth",
                  count: "7 screens",
                ...
                },
                {
                  ...
                  count: "2 screens",
                  color: GR,
                  items: ["O1 Minimal V1", "O1b Full V2"],
                },
                {
                  name: "Deposit",
                  count: "7 screens",
                  color: "#EF4444",
                  items: ["D1 Method", "D2–D5 Payment", "D6–D7 Result"],
                },
                {
                  name: "Withdraw",
                  count: "7 screens",
                  color: "#F59E0B",
                  items: ["W1–W4 Dest/Review", "W5 Auth", "W6–W7 Result"],
                },
                {
                  name: "Send Ext",
                  count: "6 screens",
                  color: GR,
                  items: ["SE1–SE4 Entry", "SE5 Review", "SE6 Success"],
                },
                {
                  name: "Send Int",
                  count: "4 screens",
                  color: "#06B6D4",
                  items: ["SI1 Search", "SI2–SI4 Send"],
                },
                {
                  name: "Receive",
                  count: "3 screens",
                  color: "#EAB308",
                  items: ["R1 Asset", "R2 Network", "R3 QR Code"],
                },
                {
                  name: "Trade",
                  count: "8 screens",
                ...
                },
                {
                  ...
                  count: "5 screens",
                  color: "#EC4899",
                  items: ["12 Overview", "13 Coin/Chart", "14–16 Watchlist"],
                },
                {
                  name: "Cards",
                  count: "6 screens",
                  color: "#F97316",
                  items: ["27–30 Overview", "27–32 Manage", "33 Empty"],
                },
                {
                  name: "Profile",
                  count: "10 screens",
                ...
                <StaggerItem key={name}>
                  <div className="rounded-xl border border-white/8 bg-white/[0.02] p-4">
                    ...
                    {items.map((it) => (
                      <p
                        key={it}
                        className="text-[10px] text-white/35 leading-relaxed"
                      >
                        {it}
                      </p>
                    ))}
          ...
          <FadeUp delay={0.15} className="mt-5">
            <div className="rounded-xl border border-white/8 bg-white/[0.02] px-5 py-3 flex items-start gap-3">
              ...
              <p className="text-[13px] text-white/45 leading-relaxed">
                The full IA tree with 14 columns, SVG connectors, and all 10
                user journey flow diagrams is available as a separate
                5200×5000px Figma frame —{" "}
                <strong className="text-white/60">
                  IA & Flow Map (node 391:4719)
                </strong>
              </p>
            </div>
          </FadeUp>
      ...
      <section className="py-10 sm:py-14 px-3 sm:px-6">
        <FadeUp className="max-w-[1100px] mx-auto">
          <div
            className="rounded-2xl sm:rounded-3xl overflow-hidden border-2 shadow-[0_0_80px_rgba(1,186,75,0.12)] aspect-[4/5] sm:aspect-[16/9]"
            style={{ borderColor: `${GR}44` }}
          >
            <img
              src={mockup13}
              alt="YDpay mockup"
        ...
        <div className="max-w-[1100px] mx-auto text-center">
          <FadeUp>
            ...
            <p className="text-[16px] sm:text-[17px] leading-[1.65] text-white/55 max-w-[520px] mx-auto mb-10">
              This redesign represents over 96 screens of intentional, premium
              design. Every decision was made with the user's trust — and your
              product's success — in mind.
            </p>
            ...
            <div className="inline-flex items-center gap-3 rounded-2xl border border-white/8 bg-white/[0.03] px-5 py-4">
              ...
              <div className="text-left">
                <p className="text-sm font-bold text-white">
                  Richard Enoch Adesiyan
                </p>
                <p className="text-[11px]" style={{ color: GR }}>
                  Lead Designer · ADLM Studio
                </p>
                <p className="text-[10px] text-white/35">
                  YDPay Mobile App Redesign · 2026
                </p>
              </div>
            </div>
          </FadeUp>
            ...
            <div className="rounded-2xl border border-white/8 bg-white/[0.025] p-8 sm:p-10 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
              <div>
                ...
                <p className="text-[14px] text-white/50 leading-[1.65] max-w-[420px]">
                  The typography, palette, and visual language this app inherits
                  came from the brand foundation phase — designed first, so the
                  product had something coherent to build on.
                </p>
              </div>
              <Link
