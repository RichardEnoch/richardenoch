...
const GALLERY = [
  ...
  {
    src: "https://res.cloudinary.com/dirgfivvb/image/upload/v1769321049/richard_portfolio/ui-projects/jigcblx6xhr1gp2lzyn4.jpg",
    alt: "Goal-Based Savings",
  },
  {
    src: "https://res.cloudinary.com/dirgfivvb/image/upload/v1769321056/richard_portfolio/ui-projects/pvpc21jwfafqngmkziat.jpg",
    alt: "AI-Driven Budgeting",
  },
  {
    src: "https://res.cloudinary.com/dirgfivvb/image/upload/v1769321093/richard_portfolio/ui-projects/v4ya1xzvcnsqdvalhsyf.jpg",
    alt: "Peer & Group Savings",
  },
  {
    src: "https://res.cloudinary.com/dirgfivvb/image/upload/v1769321097/richard_portfolio/ui-projects/kti7cjgyvdsuyibiuauh.jpg",
    alt: "Save in Dollars",
  },
  {
    src: "https://res.cloudinary.com/dirgfivvb/image/upload/v1769321099/richard_portfolio/ui-projects/iidufeh4dlsgqz2ejnbs.jpg",
    alt: "Invest",
  },
  {
...
const Lightbox = ({ images, startIndex, onClose }) => {
  ...
  const btnCls =
    "flex items-center justify-center rounded-full border border-white/20 bg-white/10 text-white hover:bg-white/20 transition";
        ...
        {images.map((_, i) => (
          <motion.button
            ...
            animate={{
              width: i === idx ? 20 : 6,
              opacity: i === idx ? 1 : 0.3,
              backgroundColor: i === idx ? GR : "#ffffff",
            }}
            transition={{ duration: 0.3 }}
            style={{
              height: 6,
          ...
          <div className="relative max-w-[1100px] mx-auto">
            ...
            <FadeUp delay={0.1}>
              ...
              <p className="text-[16px] sm:text-[18px] leading-[1.65] text-white/55 max-w-[580px] mb-4">
                Designing a student-focused savings and budgeting platform for
                life after school.
              </p>
              <p className="text-[15px] leading-[1.65] text-white/35 max-w-[560px] mb-10">
                A look back at my first UI/UX project — and what I'd do
                differently today.
              </p>
            </FadeUp>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              <FadeUp>
                ...
                <p className="text-[15px] sm:text-[16px] leading-[1.65] text-white/55 mb-5 text-justify">
                  SavedUp is a mobile savings and budgeting platform designed to
                  help university students and recent graduates prepare
                  financially for life after school. Unlike traditional savings
                  apps that focus on short-term goals, SavedUp is centred on
                  post-school outcomes—relocation, further education, business
                  setup, and career transition.
                </p>
                <p className="text-[15px] sm:text-[16px] leading-[1.65] text-white/55 mb-8 text-justify">
                  The product helps students build disciplined saving habits
                  early, giving them structure, accountability, and visibility
                  into long-term financial goals.
                </p>
              ...
              <FadeUp delay={0.15}>
                <div className="rounded-2xl border border-white/8 bg-white/[0.025] p-5">
                  ...
                  <p className="text-[15px] leading-[1.65] text-white/50 mb-5">
                    Concept, research, flows, and UI — end to end. This was my
                    first UI/UX project, used to learn product thinking and
            ...
            <div className="grid lg:grid-cols-[1fr_420px] gap-12 lg:gap-16 items-end">
              <FadeUp delay={0.1}>
                ...
                <p className="text-[15px] sm:text-[16px] leading-[1.65] text-white/55 mb-8">
                  Most students graduate without meaningful financial
                  preparation for life after school. From research and
                  real-world observation, three core issues stood out.
                </p>
          ...
          <div className="max-w-[1100px] mx-auto">
            <FadeUp>
              ...
              <p className="mt-5 text-[15px] sm:text-[16px] leading-[1.65] text-white/55 max-w-[600px]">
                Research combined surveys, informal interviews, and usability
                testing to validate the problem and shape the product strategy.
              </p>
            </FadeUp>
                  ...
                  <div className="overflow-x-auto flex-1">
                    <table className="w-full h-full text-left border-collapse">
                      ...
                      <tbody>
                        {[
                          {
                            feature: "After-School Focused Savings",
                            s: true,
                            p: false,
                            c: false,
                          },
                          {
                            feature: "AI-Driven Budgeting & Insights",
                            s: true,
                            p: false,
                            c: false,
                          },
                          {
                            feature: "Target / Goal-Based Savings",
                            s: true,
                            p: true,
                            c: true,
                          },
                          ...
                          {
                            feature: "SafeLock (Locked Savings)",
                            s: true,
                            p: true,
                            c: true,
                          },
                          ...
                          {
                            feature: "Gamification (Streaks & Rewards)",
                            s: true,
                            p: true,
                            c: true,
                          },
                    ...
                    <div className="flex items-center gap-5">
                      <div className="relative shrink-0 w-[90px] h-[90px]">
                        ...
                        >
                          ...
                          <motion.circle
                            ...
                            whileInView={{
                              strokeDashoffset: 238.76 * (1 - 0.7865),
                            }}
                      ...
                      <div>
                        ...
                        <p className="text-[15px] leading-[1.6] text-white/50">
                          validated the problem — confirming no student-specific
                          savings solution existed.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="rounded-2xl border border-white/8 bg-white/[0.025] p-5 flex-1 flex flex-col justify-center">
                    ...
                    <StaggerGrid className="space-y-2">
                      {[
                        ...
                        {
                          dot: "#A78BFA",
                          text: "Visible progress drives commitment",
                        },
                        {
                          dot: "#F59E0B",
                          text: "Long-term goal clarity is critical",
                        },
                      ].map(({ dot, text }) => (
          ...
          <div className="max-w-[1100px] mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-end">
              <FadeUp delay={0.1}>
                ...
                />
                <p className="text-[15px] sm:text-[16px] leading-[1.65] text-white/55 mb-8">
                  SavedUp was designed around one core principle:{" "}
                  <strong className="text-white">
                    Help students save with purpose, structure, and
                    accountability for life after school.
                  </strong>
                </p>
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    <li
                      key={n}
                      className="flex items-start gap-4 rounded-2xl border border-white/8 bg-white/[0.025] p-4"
                    >
                      <span
          ...
          <div className="max-w-[1100px] mx-auto">
            <FadeUp>
              ...
              <p className="mt-5 text-[15px] sm:text-[16px] leading-[1.65] text-white/55 max-w-[560px]">
                Five core features, each built around a specific user behaviour
                challenge — not just functionality for its own sake.
              </p>
            </FadeUp>
              ...
              {FEATURES.map(({ n, name, desc, img }, i) => {
                ...
                return (
                  <FadeUp key={n} delay={0.05 * i}>
                    <div
                      className={`grid lg:grid-cols-2 gap-6 lg:gap-10 items-center ${isEven ? "" : "lg:[&>*:first-child]:order-2"}`}
                    >
                      {/* text */}
                      <div className="rounded-2xl border border-white/8 bg-white/[0.025] p-6 sm:p-8 h-full flex flex-col justify-center">
                        <span
                          className="inline-block rounded-md px-2.5 py-0.5 text-[9px] font-bold tracking-widest uppercase mb-4 w-fit"
          ...
          <div className="max-w-[1100px] mx-auto">
            <FadeUp>
              ...
              <p className="mt-5 mb-12 text-[15px] sm:text-[16px] leading-[1.65] text-white/55 max-w-[540px]">
                Three distinct user archetypes shaped every product decision —
                from feature priority to interaction patterns.
              </p>
            </FadeUp>
            <FadeUp delay={0.1}>
              <PersonaSection />
          ...
          <div className="max-w-[1100px] mx-auto">
            <FadeUp>
              ...
              <p className="mt-5 mb-10 text-[15px] sm:text-[16px] leading-[1.65] text-white/55 max-w-[600px]">
                SavedUp is designed for students and recent graduates planning
                their next chapter.
              </p>
            </FadeUp>
            ...
            <FadeUp delay={0.1}>
              <div className="rounded-2xl border border-white/8 bg-white/[0.025] p-6">
                <p className="text-[9px] tracking-[0.3em] uppercase text-white/30 mb-3">
                  SHARED CHALLENGES ACROSS ALL USERS
                </p>
                <div className="flex flex-wrap gap-2">
                  {[
                    "Inconsistent income",
                    "Low saving discipline",
                    "Impulse spending",
            ...
            <div className="grid lg:grid-cols-[1fr_420px] gap-12 lg:gap-16 items-start">
              <FadeUp delay={0.1}>
                ...
                <p className="text-[15px] sm:text-[16px] leading-[1.65] text-white/55 mb-6">
                  The SavedUp experience was designed to feel simple,
                  intentional, and supportive — especially for students who may
                  already feel overwhelmed by money decisions.
                </p>
                <p className="text-[15px] sm:text-[16px] leading-[1.65] text-white/55 mb-8">
                  Core flows were structured to reduce friction and cognitive
                  load, with clear separation between saving, budgeting, and
                  spending activities.
                </p>
                <ul className="space-y-3">
                  {[
                    {
                      label: "Onboarding",
                      desc: "Users define clear savings goals tied to real post-school plans from day one.",
                    },
                    {
                      label: "Saving flows",
                      desc: "Dedicated goal creation with outcome framing — not just amount targets.",
                    },
                    {
                      label: "Budgeting flows",
                      desc: "Withdrawal categorization with non-judgmental, informative feedback.",
                    },
                    {
                      label: "Social flows",
                      desc: "Peer saving and community features built around support, not comparison.",
                    },
                  ].map(({ label, desc }) => (
                    <li
                      key={label}
            ...
            <div className="grid lg:grid-cols-[420px_1fr] gap-12 lg:gap-16 items-start">
              ...
              <FadeUp delay={0.15}>
                ...
                <p className="text-[15px] sm:text-[16px] leading-[1.65] text-white/55 mb-5">
                  Usability testing focused on validating whether users could
                  move through critical flows without confusion or hesitation —
                  with particular focus on onboarding, savings goal creation,
                  and withdrawal actions.
                </p>
                <p className="text-[15px] sm:text-[16px] leading-[1.65] text-white/55 mb-8">
                  Feedback revealed areas where labels were unclear and
                  transitions between budgeting and savings felt abrupt. These
                  insights directly informed copy, flow sequencing, and feedback
                  messaging.
                </p>
                <div className="rounded-2xl border border-white/8 bg-white/[0.025] p-5">
                  <p className="text-[9px] tracking-[0.3em] uppercase text-white/30 mb-3">
                  ...
                  <ul className="space-y-2">
                    {[
                      "Unclear labels in onboarding screens",
                      "Abrupt transitions between budgeting and savings",
                      "Feedback messaging tone and clarity",
                    ].map((t) => (
                      <li
                        key={t}
                        className="flex items-center gap-2.5 text-[15px] text-white/55"
                      >
                        <span
                          className="w-1.5 h-1.5 rounded-full shrink-0"
                          style={{ background: GR }}
          ...
          <div className="max-w-[1100px] mx-auto">
            <FadeUp>
              ...
              <p className="mt-5 text-[15px] sm:text-[16px] leading-[1.65] text-white/55 max-w-[580px]">
                The success of SavedUp is measured by its ability to influence
                real financial behaviour — not just feature usage.
              </p>
            </FadeUp>
                  ...
                  <StaggerItem key={metric}>
                    <div className="flex items-start gap-4 rounded-2xl border border-white/8 bg-white/[0.025] px-5 py-4">
                      ...
                      <div>
                        ...
                        <p className="text-[15px] leading-[1.65] text-white/50 line-clamp-2">
                          {desc}
                        </p>
                      </div>
                    </div>
            ...
            <FadeUp delay={0.1} className="mt-10">
              <div className="rounded-2xl border border-white/8 bg-white/[0.025] p-8 sm:p-10">
                <p className="text-[15px] sm:text-[16px] leading-[1.8] text-white/60 mb-5">
                  This project reinforced the importance of designing beyond
                  surface-level usability and focusing on{" "}
                  <strong className="text-white">behaviour change</strong>. I
                  learned that effective financial products must balance
                  structure with encouragement — especially for users navigating
                  uncertainty and limited resources.
                </p>
                <p className="text-[15px] sm:text-[16px] leading-[1.8] text-white/60 mb-5">
                  SavedUp challenged me to think deeply about motivation,
                  accountability, and long-term commitment — not just interface
                  design. It also strengthened my belief that student-focused
                  products deserve the same level of rigour and intentionality
                  as enterprise tools.
                </p>
                <p className="text-[15px] sm:text-[16px] leading-[1.8] text-white/60">
                  Ultimately, this project reflects my approach to product
                  design: grounding decisions in real user needs, designing with
                  purpose, and building systems that support long-term growth.
                </p>
                <div className="mt-8 pt-6 border-t border-white/8">
                  <div className="inline-flex items-center gap-3 rounded-2xl border border-white/8 bg-white/[0.03] px-5 py-4">
                    <div
                      className="w-9 h-9 rounded-full flex items-center justify-center font-black text-sm text-black shrink-0"
                      style={{ background: GR }}
                    >
                      R
                    </div>
                    <div>
                      ...
                      <p className="text-[11px]" style={{ color: GR }}>
                        Product Designer · Savedup Case Study · Aug 2023
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="max-w-[1100px] mx-auto">
            <FadeUp>
              ...
              <p className="text-[15px] sm:text-[16px] leading-[1.65] text-white/50 max-w-[560px] mb-10">
                Three years on. Here&apos;s what the experience taught me — and
                what I&apos;d change if I were starting this from scratch now.
              </p>
            </FadeUp>
