...
const SWATCHES = [
  {
    hex: "#2983fe",
    name: "Rion Blue",
    role: "The platform blue. Screens, stories, the digital home.",
    dark: false,
  },
  {
    hex: "#3a5a93",
    name: "Book Blue",
    role: "The deeper shelf blue that carries print and stationery.",
    dark: false,
  },
  {
    hex: "#fbbb26",
    name: "Crown Yellow",
    role: "The royalty in the name, used like a highlighter.",
    dark: true,
  },
  {
    hex: "#dccdb0",
    name: "Page Cream",
    role: "Paper warmth, so the digital brand still smells like books.",
    dark: true,
  },
];
    ...
    <div className="relative z-10">
          ...
          <div className="max-w-[820px] mx-auto flex flex-col items-center text-center">
            ...
            <FadeUp delay={0.14}>
              <p className="text-[16px] sm:text-[18px] leading-[1.65] text-white/65 max-w-[600px]">
                One platform for Nigeria's whole book world, and a mark to
                match: a crown for the name, two stacked books curving into a B,
                and <span style={{ color: G }}>a face you almost miss</span>{" "}
                watching you back.
              </p>
            </FadeUp>
          </div>
          ...
          <Reveal>
            ...
            >
              ...
              <p className="text-[16px] sm:text-[18px] leading-[1.7] text-white/70">
                BookRion set out to connect Nigeria's readers, authors,
                publishers, sellers and bookstores in one place, with dreams of
                making reading feel as habit-forming as Duolingo. They walked in
                wanting brown. The research said the category lives in blue and
                yellow, so I held that line with data instead of taste. Then I
                retired my own first logo, a fun mascot, and rebuilt it into a
                crowned B made of stacked books with eyes hidden in the letters.
                I designed the product too, so the brand and the app grew up as
                one thing. Here is how it happened.
              </p>
            </div>
          </Reveal>
        </div>
          ...
          <ScrollAlign className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            <Reveal>
              ...
              <div className="space-y-5 text-[15px] sm:text-[16px] leading-[1.7] text-white/55">
                <p>
                  BookRion is a platform for everyone the book world touches in
                  Nigeria. Readers, authors, publishers, sellers, bookstores,
                  all connected in one place, so it is easy to find a book, buy
                  it, read it online, or reach any of the people behind it. Not
                  a store. A destination.
                </p>
                <p>
                  And they were thinking past launch. The long game was a
                  gamified reading habit, closer to how Duolingo makes practice
                  feel like play. So the brand had to be friendly and playful,
                  but still solid enough to sit under a proper product. I
                  handled both sides on this one, the identity and the product
                  design, which is exactly how it should be when the brand IS
                  the product.
                </p>
              </div>
            </Reveal>
            <Reveal>
              <Frame
                src={imgAppIcon}
                alt="The BookRion app icon, the crowned B, on a phone home screen"
                ratio="4/5"
              />
            </Reveal>
          </ScrollAlign>
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-8 lg:px-16 border-t border-white/5">
        <div className="max-w-[1100px] mx-auto">
          <Reveal>
            ...
            <h2 className="type-display-3">
              <span className="text-white">They walked in with brown.</span>
              <br />
              <span style={{ color: "#E05252" }}>
                The category lives in blue.
              </span>
            </h2>
            ...
            <div className="max-w-[720px] space-y-5 text-[15px] sm:text-[16px] leading-[1.7] text-white/55">
              <p>
                Two problems sat between the brief and the brand. The first was
                colour. Their starting instinct was a brown palette, warm and
                bookish on paper. But my research kept pointing somewhere else:
                the book and reading space leans blue and yellow with a touch of
                orange, vibrant without screaming. There was a real gap between
                the direction they walked in with and what the market actually
                rewards.
              </p>
              <p>
                The second problem was mine. My first logo leaned hard into the
                gamified brief, a little mascot with eyes, and it genuinely hit
                the fun note. What it did not have was staying power. A mascot
                can front a feature. A platform that wants readers, authors and
                publishers to trust it with money and work needs a mark that can
                grow up with it.
              </p>
            </div>
          </Reveal>
        ...
        <div className="max-w-[1100px] mx-auto">
          <Reveal>
            ...
            <div className="max-w-[720px] space-y-5 text-[15px] sm:text-[16px] leading-[1.7] text-white/55 mb-10">
              <p>
                The rebuild started with the name itself. Rion sounds like
                royalty, so a crown went on top. Books stack, so two rounded
                book forms sit together underneath, and their shared curve
                builds a lowercase b, for Book. That is the whole logic: the
                name read literally, then drawn.
              </p>
              <p>
                And the eyes survived. Reading and discovery happen through the
                eyes, and that was the truest part of the mascot, so I folded
                them back in as the double letters, with a small bookmark ribbon
                tucked inside the shape for purpose and focused reading. Look
                once and you see a crowned b. Look again and the mark is quietly
                watching you back. Crown on top, books underneath, a face you
                almost miss.
              </p>
              <p>
                It landed warm and a little cheeky, which is exactly what a
                habit product wants, without tipping into childish. The
                playfulness the brief asked for is still there. It just wears a
                crown now. The BMark, as the look book names it, shows what
                BookRion is all about: reading, learning, and leading.
              </p>
            </div>
          </Reveal>
          ...
          <Reveal>
            <div className="rounded-2xl overflow-hidden border border-white/8">
              <img
                src={imgBMark}
                alt="The BMark rationale from the look book: the book forms, the bookmark ribbon, and the crown for Rion, annotated"
                loading="lazy"
                className="w-full h-auto"
              />
            </div>
            <p className="mt-4 text-[14px] text-white/40 leading-relaxed max-w-[640px]">
              The BMark rationale from the look book. The book is the central
              motif, the ribbon is the bookmark, and the crown carries the Rion.
            </p>
          </Reveal>
        ...
        <div className="max-w-[1100px] mx-auto">
          <Reveal>
            ...
            <div className="mt-6 max-w-[720px] space-y-5 text-[15px] sm:text-[16px] leading-[1.7] text-white/55 mb-12">
              <p>
                Moving a client off the colour they arrived with takes more than
                opinion, so I did not offer one. I showed them where the reading
                category actually lives: blue for trust and depth, yellow for
                energy and reward, the combination every serious player in the
                space keeps landing on for a reason. This is what the market
                shows, not what I prefer. That framing is what carried them.
              </p>
              <p>
                The final palette keeps a little of what they loved anyway. The
                cream carries the warmth their brown instinct was reaching for,
                just translated into the colour of an actual page.
              </p>
            </div>
          </Reveal>
          ...
          <Reveal>
            ...
            <p className="text-[11px] text-white/25 mb-16">
              Sampled from the shipped applications.
            </p>
          </Reveal>
          ...
          <Reveal>
            ...
            <p className="text-[20px] sm:text-[22px] font-semibold text-white mb-5">
              One system, from the logo to the last screen
            </p>
            <div className="max-w-[720px] space-y-5 text-[15px] sm:text-[16px] leading-[1.7] text-white/55 mb-10">
              <p>
                Because I designed the product too, the identity never had to be
                translated by someone else. The crowned B became the app icon.
                Rion Blue became the interface. Crown Yellow became the reward
                moments, the streaks and the highlights where a habit product
                earns its keep. Library, activity, discovery, every screen
                speaks the same language the logo does.
              </p>
              <p>
                That is the quiet advantage of doing brand and product as one
                job. There is no seam where the logo ends and the app begins.
              </p>
            </div>
            <div className="rounded-2xl overflow-hidden border border-white/8">
              <img
                src={imgScreens}
                alt="BookRion app screens: home, library and activity, all carrying the brand system"
                loading="lazy"
                className="w-full h-auto"
              />
            </div>
        ...
        <div className="max-w-[1100px] mx-auto">
          <Reveal>
            ...
            <p className="mt-5 text-[15px] sm:text-[16px] leading-[1.7] text-white/55 max-w-[620px] mb-14">
              A platform lives on screens, but a brand earns belief in the
              physical world. The system had to hold in both.
            </p>
          </Reveal>
            ...
            {[
              ...
              <Reveal key={title}>
                <div className="flex flex-col gap-5">
                  ...
                  <Frame
                    src={img}
                    alt={`${title}. BookRion brand application`}
                    ratio={ratio}
        ...
        <div className="max-w-[1100px] mx-auto">
          <Reveal>
            ...
            <p className="mt-5 text-[15px] sm:text-[16px] leading-[1.7] text-white/55 max-w-[560px] mb-12">
              This project produced one of my favourite designer memories, a
              real, healthy argument on a call. These are the calls that came
              out of it.
            </p>
          </Reveal>
      ...
      <BrandGallery
        ...
        images={[
          ...
          {
            src: imgScreens,
            alt: "The app screens carrying the brand system",
            label: "APP SCREENS",
          },
          {
            src: imgPhonesBlue,
            alt: "Marketing screens on Rion Blue",
            label: "MARKETING",
          },
          {
            src: imgAppIcon,
            alt: "The crowned B as the app icon",
            label: "APP ICON",
          },
          {
            src: imgNotebook,
            alt: "The mark at full size on a notebook",
            label: "NOTEBOOK",
          },
          { src: imgTote, alt: "Fuel your mind tote bag", label: "TOTE BAG" },
          {
            src: imgCards,
            alt: "Business cards in shelf blue and cream",
            label: "BUSINESS CARDS",
          },
          {
            src: imgCardsAlt,
            alt: "Business cards, alternate angle",
            label: "CARDS II",
          },
          {
            src: imgLetterhead,
            alt: "Branded letterhead",
            label: "LETTERHEAD",
          },
        ]}
      />
        ...
        <div className="max-w-[860px] mx-auto">
          <Reveal>
            ...
            <div className="mt-8 space-y-5 text-[15px] sm:text-[16px] leading-[1.75] text-white/60">
              <p>
                They were thrilled. The brand and the product came together as
                one considered thing instead of a logo bolted onto an app, the
                crowned B running from the sign outside to the reward screens
                inside, on a palette the category itself argued for.
              </p>
              <p>
                This is the project I point to when someone asks what it looks
                like when a designer pushes back and the work comes out better
                for it. The disagreement was real, the argument was healthy, and
                the mark that came out the other side wears a crown it earned.
              </p>
            </div>
          </Reveal>
