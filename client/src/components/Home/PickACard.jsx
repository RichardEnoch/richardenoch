            ...
            >
              ...
              <div
                style={{
                  ...
                  inset: 0,
                  background:
                    "linear-gradient(to top, rgba(0,0,0,0.92) 0%, rgba(0,0,0,0.75) 28%, rgba(0,0,0,0.2) 52%, transparent 100%)",
                }}
              />
    ...
    <>
      ...
      >
        <div className="sticky top-0 h-screen overflow-hidden flex flex-col items-center justify-center">
          ...
          {/* heading */}
          <motion.div
            className="text-center pointer-events-none mt-20"
