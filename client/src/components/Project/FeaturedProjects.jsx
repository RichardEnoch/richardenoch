...
/* ADLM leads this deck, and its card points at the case-study hub. The hub
   is the last page to publish — it summarises the four cases and three of
   them are unfinished — so until then the deck runs one project shorter
   rather than opening with a card that cannot be clicked. */
const PROJECTS = ALL_PROJECTS.filter((p) => p.id !== "adlm" || adlmLive("hub"));
