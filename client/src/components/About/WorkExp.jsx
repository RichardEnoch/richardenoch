...
const WorkExp = () => {
  ...
  return (
    <section
      id="work-experience"
      className="w-full bg-[#050505] py-12 md:py-16"
    >
            ...
            >
              <div className="grid gap-6 md:grid-cols-[420px_1fr] py-8 first:pt-0">
                <div>
                  ...
                  {exp.role && (
                    <p className="mt-3 text-[15px] sm:text-[16px] text-neutral-300">
                      {exp.role}
                    </p>
                  )}
                  {exp.durationLabel && (
                    <p className="mt-2 text-[12px] sm:text-[13px] text-[#89ff00] tracking-wide">
                      {exp.durationLabel}
                    </p>
                  )}
                </div>
